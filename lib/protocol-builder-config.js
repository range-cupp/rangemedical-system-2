...
export const BUILDER_ITEMS = [
  ...
  // ═══ PEPTIDES — MITOCHONDRIAL & ENERGY ════════════════════════════════════
  {
    ...
    included: ['Take-home vial', 'Daily injections — 25-50 day supply depending on dose'],
    priceCents: 46200, billingType: 'flat', duration: null, durationLabel: 'Per vial', paymentOptions: {},
  },
  {
    id: 'pep90-nad-inj',
