...
export const LOCATION_ENABLED_CATEGORIES = [];
...
export const APPOINTMENT_SERVICES = {
  ...
  'Medical Procedures': [
    { name: 'PRP Procedure', duration: 60, category: 'procedure', calcomSlug: 'medical-procedure-prp' },
    { name: 'Testosterone Pellet Procedure', duration: 60, category: 'procedure', calcomSlug: 'medical-procedure-pellet' },
  ],
  'Consultations': [
    { name: 'Initial Conversation', duration: 30, category: 'initial_conversation', calcomSlug: null, hasModality: true },
    { name: 'Initial Consultation', duration: 45, category: 'other', calcomSlug: 'initial-consultation', hasModality: true },
    { name: 'Follow-Up Consultation', duration: 20, category: 'follow_up_consultation', calcomSlug: 'follow-up-consultation', hasModality: true },
    { name: 'Initial Lab Review', duration: 45, category: 'other', calcomSlug: 'initial-lab-review', hasModality: true, allowedModalities: ['in_clinic', 'telemedicine'] },
    { name: 'Follow-Up Lab Review', duration: 45, category: 'other', calcomSlug: 'follow-up-lab-review', hasModality: true, allowedModalities: ['in_clinic', 'telemedicine'] },
  ],
};
...
export const PROVIDERS = {
  ...
  iv: [
    { name: 'Lily', label: 'Lily', calcomUsername: 'lily' },
    { name: 'Damien', label: 'Damien', calcomUsername: 'damien' },
    { name: 'Brendyn Reed', label: 'Brendyn', calcomUsername: 'brendyn' },
  ],
  phlebotomy: [
    { name: 'Lily', label: 'Lily', calcomUsername: 'lily' },
    { name: 'Evan', label: 'Evan', calcomUsername: 'evan' },
...
export const PREP_INSTRUCTIONS = {
  // Range IV (standard vitamin/mineral) — no prep needed
