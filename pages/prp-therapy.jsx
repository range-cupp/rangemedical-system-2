    ...
    >
      ...
      <div className="prp-page">
        ...
        <section className="prp-section prp-section-inverted">
          <div className="prp-container">
            <div className="prp-animate">
              <div className="prp-kicker">Common Questions</div>
            ...
            <div className="prp-faq-list">
              {faqs.map((faq, i) => (
                <div
                  key={i}
                  className={`prp-faq-item ${openFaq === i ? 'open' : ''}`}
                  onClick={() => toggleFaq(i)}
                >
                  <div className="prp-faq-question">
                    {faq.question}
                    <span className="prp-faq-toggle">+</span>
                  </div>
          ...
          <div className="prp-container">
            <div className="prp-animate">
              ...
              <div className="prp-cta-buttons">
                <Link href="/book" className="prp-btn-primary">Book Your Assessment</Link>
      ...
      <style jsx>{`
        ...
        .prp-faq-item.open .prp-faq-toggle {
        ...
        .prp-faq-item.open .prp-faq-answer {
          max-height: 300px;
          padding-top: 1rem;
          opacity: 1;
        }
        ...
        .prp-faq-item.open .prp-faq-question {
          color: #ffffff;
        }
