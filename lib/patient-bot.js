...
3. IMPORTANT: When the knowledge base entries above contain the answer (pricing, hours, services), you MUST include the specific numbers in your reply. Do NOT say "pricing varies" or "check the website" when you have the exact price. For example, if someone asks "how much is HRT?" and the knowledge base says "$250/month", reply with "$250/month" — don't hedge.
...
6. NEVER make up information. But DO confidently share pricing, hours, and service details that appear in the knowledge base entries above.
...
12. Never direct people to the website for information you already have in the knowledge base.`;
    ...
    const response = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'user',
            content: `Patient "${patientName}" just texted: "${messageText}"\n\nGenerate a helpful SMS reply. Keep it short and natural. If the knowledge base entries contain specific prices or details that answer this question, include them in your reply — do not redirect to the website or say "pricing varies".`,
          },
        ],
      }),
    });
