    ...
    <>
      ...
      <div id="consentContainer" className="consent-page">
        ...
        <form id="consentForm" className="consent-form">
          <div className="section"><h2 className="section-title">Patient Information</h2><div className="form-row"><div className="form-group"><label htmlFor="firstName">First Name <span className="req">*</span></label><input type="text" id="firstName" autoComplete="given-name" required /></div><div className="form-group"><label htmlFor="lastName">Last Name <span className="req">*</span></label><input type="text" id="lastName" autoComplete="family-name" required /></div></div><div className="form-row"><div className="form-group"><label htmlFor="email">Email <span className="req">*</span></label><input type="email" id="email" autoComplete="email" required /></div><div className="form-group"><label htmlFor="phone">Phone <span className="req">*</span></label><input type="tel" id="phone" autoComplete="tel" required /><p style={{ fontSize: '0.6rem', color: '#a3a3a3', lineHeight: 1.4, marginTop: '0.25rem' }}>By providing your phone number, you consent to receive text messages from Range Medical regarding your care, appointments, and health information. Message and data rates may apply. Up to 10 msg/mo. Reply STOP to opt out. <a href="/terms-of-use" target="_blank" rel="noopener noreferrer" style={{ color: '#a3a3a3', textDecoration: 'underline' }}>Terms</a> &amp; <a href="/privacy-policy" target="_blank" rel="noopener noreferrer" style={{ color: '#a3a3a3', textDecoration: 'underline' }}>Privacy</a>.</p></div></div><div className="form-row"><div className="form-group"><label htmlFor="dateOfBirth">Date of Birth <span className="req">*</span></label><input type="text" id="dateOfBirth" autoComplete="bday" placeholder="MM/DD/YYYY" maxLength="10" required /></div></div></div>
      ...
      <style jsx global>{`*{margin:0;padding:0;box-sizing:border-box}body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;background:#f9f9f9;color:#111}.consent-page{max-width:720px;margin:0 auto;background:#fff;min-height:100vh}.consent-header{background:#000;color:#fff;padding:24px 28px}.consent-header h1{font-size:22px;font-weight:700;letter-spacing:2px;margin-bottom:4px;color:#fff}.consent-header p{font-size:14px;opacity:.85;color:#fff}.consent-form{padding:0 28px 40px}.section{border-bottom:1px solid #e5e5e5;padding:28px 0}.section:last-of-type{border-bottom:none}.section-title{font-size:16px;font-weight:700;text-transform:uppercase;letter-spacing:1px;margin-bottom:16px;padding-bottom:8px;border-bottom:2px solid #000}.section-desc{font-size:14px;color:#444;margin-bottom:16px;line-height:1.5}.form-row{display:flex;gap:16px;margin-bottom:16px}.form-group{flex:1}.form-group label{display:block;font-size:13px;font-weight:600;margin-bottom:4px;color:#333}.form-group input,.form-group textarea{width:100%;padding:10px 12px;border:1px solid #ccc;border-radius: 0;font-size:14px}.form-group input:focus,.form-group textarea:focus{border-color:#000;outline:none;box-shadow:0 0 0 2px rgba(0,0,0,.1)}.req{color:#dc2626}.info-block{background:#fafafa;border:1px solid #e5e5e5;border-radius: 0;padding:20px}.info-block p{font-size:14px;line-height:1.6;color:#333;margin-bottom:12px}.info-block p:last-child{margin-bottom:0}.risk-list{padding-left:20px;margin-top:8px}.risk-list li{font-size:13px;line-height:1.5;color:#444;margin-bottom:6px}.screening-item{background:#fafafa;border:1px solid #e5e5e5;border-radius: 0;padding:16px;margin-bottom:12px}.screening-label{font-size:14px;font-weight:600;display:block;margin-bottom:6px}.radio-row{display:flex;gap:20px;margin-top:4px}.radio-row label{font-size:14px;cursor:pointer;display:flex;align-items:center;gap:6px}.details-field{margin-top:10px}.details-field label{font-size:13px;font-weight:500;display:block;margin-bottom:4px}.details-field textarea{width:100%;padding:8px 10px;border:1px solid #ccc;border-radius: 0;font-size:13px;resize:vertical}.ack-item{border:1px solid #e5e7eb;border-radius: 0;padding:14px 16px;margin-bottom:10px;transition:border-color .2s}.ack-item label{display:flex;gap:12px;cursor:pointer;align-items:flex-start}.ack-checkbox{position:absolute;opacity:0;width:0;height:0}.ack-initials{width:28px;height:28px;min-width:28px;border:2px solid #d4d4d4;border-radius: 0;display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:700;letter-spacing:0.5px;color:transparent;background:#fff;cursor:pointer;transition:all 0.15s;margin-top:1px;user-select:none}.ack-checkbox:checked+.ack-initials{background:#000;border-color:#000;color:#fff}.ack-text{font-size:13px;line-height:1.55;color:#333}.signature-container{border:2px solid #000;border-radius: 0;margin-bottom:8px;overflow:hidden}.signature-pad{width:100%;height:150px;cursor:crosshair}.signature-actions{text-align:right}.btn-clear{background:none;border:1px solid #ccc;padding:6px 14px;border-radius: 0;cursor:pointer;font-size:13px}.field-error{color:#dc2626;font-size:12px;display:block;margin-top:4px}.submit-section{padding-top:20px;text-align:center}.btn-submit{background:#000;color:#fff;border:none;padding:14px 48px;font-size:16px;font-weight:600;border-radius: 0;cursor:pointer}.btn-submit:disabled{background:#999;cursor:not-allowed}
