...
export const BUILDER_ITEMS = [
  ...
  // ═══ WEIGHT LOSS ══════════════════════════════════════════════════════════
  {
    ...
    benefits: [
      ...
      'Clinical trials show 12–15% body weight loss over 68 weeks',
      'Improves insulin sensitivity, blood sugar, and cardiovascular markers',
      'Gradual dose titration minimizes side effects',
    ],
    bestFor: 'Patients with 20–50+ lbs to lose, especially with metabolic concerns',
    included: [
  ...
  },
  {
    ...
    benefits: [
      'Targets two pathways (GIP + GLP-1) for enhanced weight loss vs semaglutide alone',
      'Clinical trials show 15–22% body weight loss — strongest results in class',
    ...
    bestFor: 'Patients wanting maximum weight loss efficacy, especially with insulin resistance',
    included: [
      'Weekly GLP-1 injection (in-clinic or take-home)',
      'Vitamin injection with each weight loss injection',
      'Monthly provider check-in',
  ...
  },
  {
    ...
    benefits: [
      ...
      'Phase 2 trials show up to 24% body weight loss at 48 weeks — unprecedented results',
      'Glucagon receptor activation increases energy expenditure and fat burning',
      'Emerging data suggests superior muscle mass preservation vs other GLP-1s',
    ],
    bestFor: 'Patients with significant weight to lose (50+ lbs) or who plateaued on semaglutide/tirzepatide',
    included: [
      'Weekly GLP-1 injection (in-clinic or take-home)',
      'Vitamin injection with each weight loss injection',
      'Monthly provider check-in',
