...
export async function runBookingAutomations({ appointmentId, calcomBookingId, eventTypeSlug, serviceCategory, patientId, patientName, patientEmail, patientPhone, serviceName, startTime }) {
  ...
  // Will be re-enabled later, likely sourced from the new
  // service_prep_instructions table (admin-editable per service) instead
  // of the hardcoded PREP_INSTRUCTIONS map in lib/appointment-services.js.
