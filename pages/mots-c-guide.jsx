  ...
  return (
    ...
    >
      ...
      <style jsx>{`
        ...
        .protocol-option-card { background: #ffffff; border: 2px solid #e5e5e5; border-radius: 999px; padding: 1.75rem; }
        ...
        .phase-card { background: #ffffff; border: 1px solid #e5e5e5; border-radius: 999px; padding: 1.75rem; margin-bottom: 1.25rem; }
