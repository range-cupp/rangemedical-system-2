...
export const FORM_DEFINITIONS = {
  ...
  'knee-aspiration': { name: 'Knee Aspiration Consent', path: '/consent/knee-aspiration', time: '5 min' },
  'questionnaire': { name: 'Baseline Questionnaire', path: '/questionnaire', time: '10 min' },
  'hrt-questionnaire-male': { name: 'HRT Questionnaire (Male)', path: '/hrt-questionnaire-male', time: '8 min' },
};
...
export const CONSENT_TYPE_TO_FORM_ID = {
  ...
  'baseline_questionnaire': 'questionnaire',
};
...
export async function createFormBundle({ formIds, patientId, patientName, patientEmail, patientPhone, ghlContactId, metadata }) {
