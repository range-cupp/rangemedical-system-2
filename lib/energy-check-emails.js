...
export function getResultsEmailHtml({ firstName, score, severity, bookingUrl }) {
...
export function getDay1EmailHtml({ firstName, score, severity, bookingUrl }) {
  const severityColor = SEVERITY_COLORS[severity] || '#171717';
  const ctaLabel = 'See Lab Panels';
...
export function getDay3EmailHtml({ firstName, score, severity, bookingUrl }) {
  const ctaLabel = 'See Lab Panels';
...
export function getDay7EmailHtml({ firstName, bookingUrl }) {
  const ctaLabel = 'See Lab Panels';
