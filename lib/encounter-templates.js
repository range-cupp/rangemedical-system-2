...
export function getTemplateForService(serviceName) {
  ...
  if (name.includes('peptide') || name.includes('bpc') || name.includes('tb-4') || name.includes('tb4')) return 'injection';
