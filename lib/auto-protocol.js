  ...
  switch (protocolType) {
    case 'weight_loss': {
      ...
      return {
        ...
        next_expected_date: calculateNextExpectedDate({ protocolType: 'weight_loss', startDate: today, pickupFrequency: 7 }),
      };
    }
...
async function extendProtocol(protocol, protocolType, serviceName) {
  ...
  switch (protocolType) {
    case 'weight_loss': {
      ...
      updateData.next_expected_date = calculateNextExpectedDate({ protocolType: 'weight_loss', startDate: todayStr, pickupFrequency: 7 });
