...
export async function guardDoseChange(supabase, currentProtocol, update, opts = {}) {
  ...
  const reason = isWL
    ? 'Weight-loss dose changes require provider approval. Use the Change Dose action on the patient profile to send an approval request to Dr. Burgess or Brendyn Reed FNP.'
    : 'HRT dose changes require provider approval. Use the Change Dose action on the patient profile to send an approval request to Dr. Burgess or Brendyn Reed FNP.';
