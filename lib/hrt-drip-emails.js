...
const HRT_ONBOARDING_SEQUENCE = [
  {
    ...
    smsText: 'Hey {{contact.first_name}}! Welcome to your HRT program at Range Medical. Check your email for everything you need to get started — including info about your monthly Range IV ($225 value, included). Questions? Call us at (949) 997-3988'
  },
  {
    ...
    smsText: 'Hey {{contact.first_name}}, we just sent your injection guide to your email — check it out when you get a chance. If you want a hands-on walkthrough, come by the clinic anytime!',
    conditional: true
  },
  {
    ...
    smsText: 'Hi {{contact.first_name}}, how did your first week on HRT go? Any questions about your injections or how you\'re feeling? We\'re here to help — just reply or call (949) 997-3988'
  },
  {
    stepId: 'month1_iv',
    day: 28,
    ...
    smsText: 'Hey {{contact.first_name}}! Your monthly Range IV is included with your HRT membership ($225 value). Ready to book? Call (949) 997-3988 or reply here!'
  },
  {
    ...
    smsText: 'Heads up {{contact.first_name}} — your 8-week follow-up labs are coming up in about 2 weeks. No action needed yet, just a heads up so you can plan ahead!'
  },
  {
    stepId: 'book_labs',
    day: 56,
    ...
    html: BOOK_LABS_HTML,
    smsText: 'Hi {{contact.first_name}}, it\'s time for your 8-week follow-up labs! These are included with your membership. Call (949) 997-3988 to schedule your blood draw.'
  }
];
...
const RECURRING_REMINDERS = [
  {
    ...
    smsText: 'Hey {{contact.first_name}}! Friendly reminder — your monthly Range IV is included with your HRT membership. Call (949) 997-3988 to book!'
  },
  {
    type: 'lab_reminder',
    intervalDays: 84,
    ...
    smsText: 'Hi {{contact.first_name}}, it\'s time for your quarterly follow-up labs (included with your membership). Call (949) 997-3988 to schedule your blood draw.'
  }
];
