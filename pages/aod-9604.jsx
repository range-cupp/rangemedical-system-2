          ...
          <div className="container">
            ...
            <div className="aod-protocol-card">
              ...
              <div className="aod-protocol-note">
                <strong>Note:</strong> Dosing is always personalized at Range Medical. We use your lab results and health history to determine the right protocol. Higher doses have not been shown to produce significantly better results — consistency matters more. <Link href="/assessment" style={{ color: '#000000', fontWeight: 600 }}>Get started</Link> with Range Medical.
              </div>
            </div>
          </div>
        </section>
