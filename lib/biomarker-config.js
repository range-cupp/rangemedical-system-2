...
const biomarkerGroups = {
  ...
  'Thyroid': [
    ...
    { key: 'total_t4', label: 'Total T4', unit: 'µg/dL' },
    { key: 'reverse_t3', label: 'Reverse T3', unit: 'ng/dL' },
  ...
  'Lipids': [
    ...
    { key: 'chol_hdl_ratio', label: 'Chol/HDL Ratio', unit: '' },
    ...
    { key: 'apo_b_a1_ratio', label: 'Apo B/A1 Ratio', unit: '' },
    { key: 'lp_a', label: 'Lp(a)', unit: 'mg/dL' }
  ],
  'Vitamins & Minerals': [
  ...
  'Electrolytes': [
    ...
    { key: 'anion_gap', label: 'Anion Gap', unit: '' }
  ],
  ...
  'Prostate': [
    ...
    { key: 'psa_free_percent', label: '% Free PSA', unit: '%' }
  ]
};
...
/**
 * Compute flag for a biomarker value against reference and optimal ranges.
 * Returns: 'high', 'low', 'borderline_high', 'borderline_low', 'optimal', 'normal', or null
 */
...
module.exports = { biomarkerGroups, biomarkerMap, allBiomarkerKeys, categoryOrder, computeFlag };
