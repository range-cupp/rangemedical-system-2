...
export async function postImportActions(supabase, patientId, patientName, testDate, reviewerIds) {
  ...
  // NOTE: Scheduling tasks for Tara + Damon are NOT created here.
  // They fire later — when Evan or Dr. Burgess advances the pipeline
  // to "provider_reviewed" in /api/admin/labs-pipeline.js.
}
