      ...
      <div className="fs-page">
        {!done ? (
            ...
            <section className="fs-form-section">
              <form ref={formRef} onSubmit={handleSubmit}>
                ...
                <div className="fs-step">
                  ...
                  <h2>
                    If HBOT turns out to be a fit, could you invest in an ongoing plan
                    (roughly $200–$500/month)?
                  </h2>
          ...
          <section className="fs-done">
            ...
            <p>
              Your free hyperbaric oxygen session is reserved. We’ll text you within
