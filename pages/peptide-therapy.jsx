      ...
      <section className="section section-gray">
        <div className="container">
          ...
          <div className="doors-grid">
            ...
            <div className="door-card">
              <h4>4. Self-Administration</h4>
              <p>Most peptides are subcutaneous injections (tiny needle, minimal discomfort). We teach you exactly how to do it—it's easier than you think. Daily or as prescribed.</p>
            </div>
            <div className="door-card">
              <h4>5. Monitoring & Adjustments</h4>
        ...
        <div className="container">
          ...
          <div className="tools-grid">
            <div className="tool-card">
              ...
              <p>2-4 weeks. BPC-157 and TB-500 often show noticeable improvement within weeks.</p>
            </div>
            <div className="tool-card">
              <h4>GH Peptides</h4>
              <p>4-8 weeks. Sleep and recovery improve first; body composition changes take longer.</p>
            </div>
            <div className="tool-card">
              <h4>Full Protocol</h4>
              <p>8-12 weeks. Most patients complete a full cycle before assessing overall results.</p>
            </div>
          </div>
