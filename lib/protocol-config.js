...
export const PEPTIDE_PRODUCT_CATALOG = [
  ...
  // ── BDNF (Cognitive) ───────────────────────────────────────────
  {
    ...
    durations: [
      { days: 28, label: '4 Weeks (1 Phase)' },
    ],
    totalInjections: 20,
    phases: [
      { phase: 1, label: 'Phase 1 (4 weeks)', dose: '200mcg', price: null },
      { phase: 2, label: 'Phase 2 (4 weeks)', dose: '400mcg', price: null },
      { phase: 3, label: 'Phase 3 (4 weeks)', dose: '600mcg', price: null },
    ],
    matchPatterns: [
  ...
  // ── 2X Blend: Tesamorelin / Ipamorelin (GH) ───────────────────
  {
    ...
    defaultFrequency: '5 on / 2 off',
    guideSlug: '/tesamorelin-ipamorelin',
    deliveryOptions: ['take_home'],
    durations: [
      { days: 30, label: '30 Day' },
    ],
...
export const getGuideSlug = (medication, programName) => {
  ...
  if (text.includes('tesa') && text.includes('ipa')) return '/tesamorelin-ipamorelin';
