    ...
    >
      ...
      <section className="section">
        <div className="container">
          ...
          <p className="section-subtitle">From hormone optimization to cellular recovery — everything under one roof.</p>
      ...
      <style jsx>{`
        ...
        .accordion-list { display: flex; flex-direction: column; margin-top: 1.5rem; }
        ...
        .accordion-body { padding: 0 1.5rem 1.25rem 1.5rem; }
