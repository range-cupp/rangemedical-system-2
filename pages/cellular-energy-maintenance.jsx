      ...
      <section className="hero">
        ...
        <div className="hero-cta">
          <p className="hero-secondary">
            This page is for 6-Week Reset graduates. <Link href="/assessment"><strong>Not a graduate?</strong></Link>
          </p>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="faq-container">
            ...
            <div className="faq-item">
              ...
              <p>Maintenance is for Reset graduates. If you're starting fresh, <Link href="/assessment"><strong>start here</strong></Link>.</p>
            </div>
          </div>
        </div>
      </section>
