...
export default function HcgGuide() {
  ...
  return (
    <Layout
      title="HCG Peptide Guide | Range Medical"
      description="Your guide to HCG therapy. Testosterone support, testicular function, and fertility preservation for men on TRT. Range Medical, Newport Beach. (949) 997-3988"
    >
      <Head>
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "MedicalWebPage", "name": "HCG Peptide Guide", "description": "Patient guide for HCG peptide therapy including protocol details, timeline, and safety information.", "url": "https://www.range-medical.com/hcg-guide", "provider": { "@type": "MedicalBusiness", "name": "Range Medical", "telephone": "+1-949-997-3988", "address": { "@type": "PostalAddress", "streetAddress": "1901 Westcliff Dr. Suite 10", "addressLocality": "Newport Beach", "addressRegion": "CA", "postalCode": "92660", "addressCountry": "US" } } }) }} />
      </Head>
      ...
      <section className="peptide-hero">
        <div className="container">
          ...
          <h1>HCG</h1>
          <p className="hero-sub">The testosterone support hormone — HCG (Human Chorionic Gonadotropin) keeps your natural testosterone machinery working, preserves testicular function, and protects fertility while on hormone therapy.</p>
          <div className="hero-dose">
            <div><span>Dose:</span> 500 mcg 3x per week</div>
            <div><span>Duration:</span> Ongoing with TRT</div>
          </div>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container">
          ...
          <h2 className="section-title">What Is HCG?</h2>
          <p className="section-subtitle">HCG is a glycoprotein hormone that mimics luteinizing hormone (LH) — the signal your brain normally sends to your testicles to make testosterone.</p>
          <p className="body-text">When you start testosterone replacement therapy (TRT), your brain stops sending LH because it sees plenty of testosterone already. Without that signal, your testicles shrink and stop producing their own testosterone and sperm. HCG replaces the LH signal directly — keeping the testicles active, preserving size and function, and protecting fertility. Most men on TRT at Range Medical use HCG alongside their testosterone for exactly these reasons.</p>
        </div>
      </section>
      ...
      <section className="section section-gray">
        <div className="container">
          ...
          <h2 className="section-title">What HCG Does</h2>
          <p className="section-subtitle">The main mechanisms and effects patients can expect from a well-run protocol.</p>
          <div className="info-grid">
            <div className="info-card">
              <h3>Testicular Function</h3>
              <ul>
                <li>Keeps the testicles active on TRT</li>
                <li>Prevents shrinkage</li>
                <li>Maintains natural testosterone production</li>
              </ul>
            </div>
            <div className="info-card">
              <h3>Fertility Support</h3>
              <ul>
                <li>Helps preserve sperm production</li>
                <li>Important for men who may want children</li>
                <li>Can support fertility recovery after TRT</li>
              </ul>
            </div>
            <div className="info-card">
              <h3>Hormonal Balance</h3>
              <ul>
                <li>Supports intratesticular testosterone</li>
                <li>Works alongside weekly testosterone injections</li>
                <li>Patients often report better overall well-being</li>
              </ul>
            </div>
            <div className="info-card">
              <h3>TRT Optimization</h3>
              <ul>
                <li>Standard add-on for comprehensive TRT</li>
                <li>Approximately one month of supply per vial</li>
                <li>Easy to integrate with existing protocol</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="section">
        <div className="container">
          ...
          <p className="section-subtitle">HCG tends to be a strong fit for patients dealing with the following.</p>
          <div className="info-card">
            <ul>
                <li>Men on TRT who want to preserve testicular size and function</li>
                <li>TRT patients who may want children now or in the future</li>
                <li>Men restarting natural production after pausing TRT</li>
                <li>Anyone wanting the most complete TRT protocol available</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section className="section section-gray">
        <div className="container">
          ...
          <h2 className="section-title">How to Use HCG</h2>
          ...
          <div className="info-grid">
            <div className="info-card">
              ...
              <p>Typically 500 mcg three times per week — about 12 injections per month.</p>
            </div>
            <div className="info-card">
            ...
            <div className="info-card">
              <h3>Duration</h3>
              <p>Ongoing as long as you're on TRT. Stopping TRT? Your provider may keep HCG going temporarily to restart your natural production.</p>
            </div>
            <div className="info-card">
              <h3>Storage</h3>
              <p>Keep refrigerated at all times. Do not freeze. Let the vial come closer to room temperature before injection.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="timeline-grid">
            <div className="timeline-card">
              <h4>Week 1-2</h4>
              <p>Testicular function starts to re-engage. Most men feel the effect as slightly better well-being rather than anything dramatic.</p>
            </div>
            <div className="timeline-card">
              <h4>Week 3-4</h4>
              <p>Testicular size and responsiveness typically return. Many men notice improvements in mood and libido beyond testosterone alone.</p>
            </div>
            <div className="timeline-card">
              <h4>Ongoing</h4>
              <p>HCG becomes part of your long-term TRT rhythm — keeping everything online while testosterone does its work.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section section-gray">
        <div className="container">
          ...
          <p className="section-subtitle">HCG is generally well tolerated. Contact your provider if you experience anything unusual.</p>
          <div className="info-card">
            <ul>
                <li>Generally very well tolerated</li>
                <li>Mild injection-site redness</li>
                <li>Occasional water retention or mild bloating</li>
                <li>Rare acne or skin oiliness</li>
                <li>Estrogen can rise slightly — your provider will monitor labs</li>
            </ul>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="faq-list">
            <div className="faq-item">
              <h4>Do I really need HCG with my TRT?</h4>
              <p>Not strictly, but it's strongly recommended if you care about testicular function, fertility, or long-term hormonal balance. Most Range Medical TRT patients run it.</p>
            </div>
            <div className="faq-item">
              <h4>How is this different from testosterone?</h4>
              <p>Testosterone replaces the hormone directly. HCG keeps the upstream system running so your testicles stay active and produce their own supply alongside what you're injecting.</p>
            </div>
            <div className="faq-item">
              <h4>Can this help me get my wife or partner pregnant?</h4>
              <p>HCG preserves or restores sperm production on TRT, which is the main fertility concern. Your provider can work with you on a fertility-focused protocol if needed.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <style jsx>{`
        ...
        .faq-item { background: #ffffff; border: 1px solid #e5e5e5; border-radius: 999px; padding: 1.25rem 1.5rem; }
