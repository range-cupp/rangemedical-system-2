...
function buildProtocolData(protocolType, serviceName, patientId, opts = {}, fulfillmentOpts = {}) {
  ...
  switch (protocolType) {
    ...
    case 'hrt': {
      ...
      if (freqLower.includes('weekly') && !freqLower.includes('twice') && !freqLower.includes('bi')) freqEnum = 'weekly';
      else if (freqLower.includes('twice')) freqEnum = 'twice_weekly';
      else if (freqLower.includes('every 2 week') || freqLower.includes('biweekly') || freqLower.includes('bi-weekly')) freqEnum = 'biweekly';
