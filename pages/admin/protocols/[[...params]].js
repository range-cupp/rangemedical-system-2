// =====================================================
// RANGE MEDICAL - PROTOCOL ROUTES HANDLER
// /pages/admin/protocols/[[...params]].js
// Handles /admin/protocols and /admin/protocols/[id]
// =====================================================
...
export default function ProtocolsHandler() {
  ...
  // If params[0] exists, show protocol detail, otherwise show list
  const protocolId = params?.[0];
  
  if (protocolId) {
    return <ProtocolDetail protocolId={protocolId} />;
  }
...
// =====================================================
// PROTOCOLS LIST (placeholder - redirects to dashboard)
// =====================================================
...
// PROTOCOL DETAIL
// =====================================================
function ProtocolDetail({ protocolId }) {
  const router = useRouter();
  ...
  const handleStatusChange = async (newStatus) => {
    ...
    try {
      const response = await fetch(`/api/admin/protocols/${protocolId}/status`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
