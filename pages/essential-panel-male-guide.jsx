...
export default function EssentialPanelMaleGuide() {
  ...
  return (
    <Layout
      title="Essential Blood Panel Guide — Male | Range Medical"
      description="Your guide to the Essential Blood Panel for men. What we test, why it matters, and what comes next. Range Medical, Newport Beach. (949) 997-3988"
    >
      <Head>
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "MedicalWebPage", "name": "Essential Blood Panel Guide — Male", "description": "Patient guide for the Essential Blood Panel for men including biomarkers tested and what to expect.", "url": "https://www.range-medical.com/essential-panel-male-guide", "provider": { "@type": "MedicalBusiness", "name": "Range Medical", "telephone": "+1-949-997-3988", "address": { "@type": "PostalAddress", "streetAddress": "1901 Westcliff Dr. Suite 10", "addressLocality": "Newport Beach", "addressRegion": "CA", "postalCode": "92660", "addressCountry": "US" } } }) }} />
      </Head>
      ...
      <section className="peptide-hero">
        <div className="container">
          ...
          <h1>Essential Blood Panel — Male</h1>
      ...
      <section className="section">
        <div className="container">
          ...
          <h2 className="section-title">Your Essential Panel</h2>
          ...
          <div className="info-grid">
            <div className="info-card">
              <h3>Basic Health</h3>
              <ul>
                <li>CMP (liver, kidneys, blood sugar)</li>
                <li>Lipid Panel (cholesterol, triglycerides)</li>
                <li>CBC (blood cells, anemia, infection)</li>
              </ul>
            </div>
            <div className="info-card">
              <h3>Hormones</h3>
      ...
      <section className="section section-gray">
        <div className="container">
          ...
          <p className="section-subtitle">Based on your results, your provider may recommend one or more of the following.</p>
