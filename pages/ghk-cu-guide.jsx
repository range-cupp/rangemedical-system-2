...
export default function GHKCuGuide() {
  ...
  return (
    <Layout
      title="GHK-Cu Peptide Guide | Range Medical"
      description="Your guide to GHK-Cu copper peptide therapy. Skin rejuvenation, collagen production, and anti-aging benefits. Range Medical, Newport Beach. (949) 997-3988"
    >
      <Head>
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "MedicalWebPage", "name": "GHK-Cu Peptide Guide", "description": "Patient guide for GHK-Cu copper peptide therapy including protocol details, timeline, and safety information.", "url": "https://www.range-medical.com/ghk-cu-guide", "provider": { "@type": "MedicalBusiness", "name": "Range Medical", "telephone": "+1-949-997-3988", "address": { "@type": "PostalAddress", "streetAddress": "1901 Westcliff Dr. Suite 10", "addressLocality": "Newport Beach", "addressRegion": "CA", "postalCode": "92660", "addressCountry": "US" } } }) }} />
      </Head>
      ...
      <section className="peptide-hero">
        <div className="container">
          ...
          <h1>GHK-CU</h1>
          <p className="hero-sub">The skin rejuvenation and collagen peptide — a copper-binding compound that stimulates tissue repair, boosts collagen production, and restores youthful skin from the inside out.</p>
          <div className="hero-dose">
            <div><span>Dose:</span> 1 mg daily</div>
            <div><span>Duration:</span> 30 days — $250</div>
          </div>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container">
          ...
          <h2 className="section-title">What Is GHK-Cu?</h2>
          <p className="section-subtitle">GHK-Cu is a copper-binding tripeptide found naturally in human blood plasma. Its concentration declines significantly with age — dropping by more than 60% between the ages of 20 and 60.</p>
          <p className="body-text">GHK-Cu signals skin cells to repair, produce collagen, and rejuvenate. It plays a central role in wound healing, tissue remodeling, and maintaining skin integrity. By restoring levels through injectable peptide therapy, we support your body's own regenerative mechanisms at the cellular level.</p>
        </div>
      </section>
      ...
      <section className="section section-gray">
        <div className="container">
          ...
          <h2 className="section-title">What GHK-Cu Does</h2>
          <p className="section-subtitle">Four key mechanisms that make GHK-Cu one of the most powerful skin and tissue rejuvenation peptides available.</p>
          <div className="info-grid">
            <div className="info-card">
              <h3>Collagen Production</h3>
              <ul>
                <li>Stimulates collagen and elastin synthesis</li>
                <li>Firms and tightens skin over time</li>
                <li>Restores structural support to aging tissue</li>
              </ul>
            </div>
            <div className="info-card">
              <h3>Skin Repair</h3>
              <ul>
                ...
                <li>Reduces scarring and discoloration</li>
            ...
            <div className="info-card">
              <h3>Hair Growth</h3>
              <ul>
                <li>May stimulate hair follicle growth</li>
                <li>Supports increased hair thickness</li>
                <li>Promotes scalp health and circulation</li>
              </ul>
            </div>
            <div className="info-card">
              <h3>Anti-Aging</h3>
              <ul>
                ...
                <li>Provides antioxidant protection against damage</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="section">
        <div className="container">
          ...
          <h2 className="section-title">How to Use GHK-Cu</h2>
          ...
          <div className="info-grid">
            <div className="info-card">
              ...
              <p>Daily. Consistency is key — same time every day for best results. Set a reminder on your phone.</p>
            </div>
            <div className="info-card">
              <h3>Injection Site</h3>
              <p>Subcutaneous injection in the abdomen. Rotate injection sites daily to prevent irritation.</p>
            </div>
            <div className="info-card">
              <h3>Duration</h3>
              <p>30-day protocol. Your provider may recommend additional cycles based on your response and goals.</p>
            </div>
            <div className="info-card">
              <h3>Storage</h3>
          ...
          <div className="tip-box" style={{ marginTop: '1.5rem' }}>
            ...
            <p>GHK-Cu works best as part of a consistent daily routine. Many patients inject in the morning or before bed. Pair with good hydration and sun protection to maximize skin results.</p>
          </div>
        </div>
      </section>
      ...
      <section className="section section-gray">
        <div className="container">
          ...
          <p className="section-subtitle">Everyone responds differently, but here's what patients typically experience during a GHK-Cu protocol.</p>
          <div className="timeline-grid">
            <div className="timeline-card">
              <h4>Week 1-2</h4>
              <p>Improved skin hydration and an early glow. Many patients notice their skin feels smoother and more supple within the first two weeks.</p>
            </div>
            <div className="timeline-card">
              <h4>Week 3-4</h4>
              <p>Noticeable improvement in skin texture. Firmer, more even-toned skin. Fine lines may begin to soften as collagen production ramps up.</p>
            </div>
            <div className="timeline-card">
              <h4>Week 5+</h4>
              <p>Continued collagen remodeling and structural improvement. Hair quality may improve. Benefits compound with additional cycles.</p>
            </div>
          </div>
        </div>
      </section>
