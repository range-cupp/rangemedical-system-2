      ...
      },
      {
        ...
        fields: [
          ...
          { key: 'vitamins', label: 'Vitamins / Additives', type: 'vitamin_dose', required: true, items: [
            { name: 'Vitamin C (Ascorbic Acid)',      mgPerMl: 500,   maxCc: 10 },
            { name: 'B-Complex (B1, B2, B3, B5, B6)', mgPerMl: 100,   maxCc: 3 },
            { name: 'Vitamin B12 (Methylcobalamin)',   mgPerMl: 5,     maxCc: 3 },
            { name: 'Magnesium Chloride',              mgPerMl: 200,   maxCc: 5 },
            { name: 'Calcium Gluconate',               mgPerMl: 100,   maxCc: 5 },
            { name: 'Zinc Sulfate',                    mgPerMl: 5,     maxCc: 3 },
            { name: 'Selenium',                        mgPerMl: 0.2,   maxCc: 3 },
            { name: 'Glutathione',                     mgPerMl: 200,   maxCc: 5 },
            { name: 'Biotin',                          mgPerMl: 10,    maxCc: 3 },
            { name: 'Taurine',                         mgPerMl: 50,    maxCc: 5 },
            { name: 'L-Carnitine',                     mgPerMl: 500,   maxCc: 5 },
            { name: 'Alpha Lipoic Acid (ALA)',         mgPerMl: 50,    maxCc: 5 },
            { name: 'Dexpanthenol (B5)',               mgPerMl: 250,   maxCc: 3 },
            { name: 'NAD+',                            mgPerMl: 100,   maxCc: 10 },
            { name: 'Methylene Blue',                  mgPerMl: 10,    maxCc: 5 },
          ] },
