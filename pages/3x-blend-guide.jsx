    ...
    >
      ...
      <section className="peptide-hero">
        <div className="container">
          ...
          <div className="hero-price">$400/month</div>
        </div>
      </section>
      ...
      <section className="section section-gray">
        <div className="container">
          ...
          <h2 className="section-title">3X Blend</h2>
          <p className="section-subtitle">Three peptides that work together to help your body release more growth hormone naturally.</p>
          ...
          <div className="info-grid-three">
            ...
            <div className="info-card">
              <h3>💪 MGF</h3>
              <p className="peptide-role">The Repair Helper</p>
      ...
      <section className="section">
        <div className="container">
          ...
          <p className="body-text">The 3X Blend helps your body release more of its own growth hormone. Here's what that can mean for you:</p>
