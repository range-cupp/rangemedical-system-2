...
export const PROTOCOL_TYPES = {
  ...
  hrt_male: {
    ...
    medications: ['Testosterone Cypionate 200mg/ml', 'Testosterone Cypionate 300mg/ml'],
    dosages: [
  ...
  weight_loss_tirzepatide: {
    ...
    dosages: ['0.5mg', '1mg', '1.5mg', '2mg', '2.5mg', '3mg', '3.5mg', '4mg', '4.5mg', '5mg', '5.5mg', '6mg', '6.5mg', '7mg', '7.5mg', '8mg', '8.5mg', '9mg', '9.5mg', '10mg', '10.5mg', '11mg', '11.5mg', '12mg', '12.5mg', '13mg', '13.5mg', '14mg', '14.5mg', '15mg'],
    frequencies: [{ value: 'weekly', label: 'Once per week' }],
    injections: [
      { value: 1, label: '1 injection' },
      { value: 2, label: '2 injections' },
...
export function getDBProgramType(protocolType, duration) {
  const map = {
    'peptide': duration == 10 ? 'recovery_jumpstart_10day' :
               duration == 30 ? 'month_program_30day' : 'peptide',
