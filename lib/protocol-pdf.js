...
function getScheduleDescription(frequency) {
  ...
  if (lower.includes('every 3.5') || lower.includes('every_3_5')) return 'Every 3.5 days';
  if (lower.includes('2x') || lower.includes('twice') || lower === '2x_weekly') return 'Every 3.5 days';
...
export async function generateProtocolPdf({
  ...
  const dateStr = issueDateObj.toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' , timeZone: 'America/Los_Angeles' });
