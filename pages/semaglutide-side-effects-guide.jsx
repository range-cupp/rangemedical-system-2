...
export default function SemaglutideSideEffectsGuide() {
  ...
  return (
    <Layout
      title="Semaglutide Side Effects Guide | Range Medical"
      description="Complete guide to managing semaglutide side effects. Step-by-step instructions for nausea, heartburn, fatigue, hair changes, and more. Range Medical, Newport Beach. (949) 997-3988"
    >
      <Head>
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "MedicalWebPage",
              "name": "Semaglutide Side Effects Guide",
              "description": "Comprehensive patient guide for managing semaglutide side effects with step-by-step instructions written at an accessible reading level.",
              "url": "https://www.range-medical.com/semaglutide-side-effects-guide",
              "provider": {
      ...
      <section className="guide-hero">
        <div className="container">
          ...
          <h1>SEMAGLUTIDE<br/>SIDE EFFECTS</h1>
      ...
      <section className="section">
        <div className="container">
          ...
          <p className="section-subtitle">Semaglutide is a GLP-1 receptor agonist — it mimics a natural hormone that regulates appetite, blood sugar, and digestion. Unlike newer triple-receptor medications, semaglutide works on a single receptor system, which generally means fewer and milder side effects.</p>
          <p className="body-text">Most side effects are GI-related, mild, happen early in treatment, and improve with time as your body adjusts. For each one below, we give you a clear plan — starting with the simplest fixes and working up from there. You should never have to just "tough it out."</p>
          ...
          <div className="nav-grid">
            <a href="#nausea" className="nav-card">
              ...
              <div>
                ...
                <p>The most common. Stomach upset and queasiness.</p>
              </div>
            </a>
            ...
            <a href="#heartburn" className="nav-card">
              ...
              <div>
                ...
                <p>Burning in chest or throat, sour taste.</p>
              </div>
            </a>
      ...
      <section className="section section-gray" id="nausea">
        <div className="container">
          ...
          <div className="se-freq">Affects roughly 3-4 out of 10 people, worst in the first 1-2 weeks at each new dose level</div>

          <div className="what-box">
            <h3>What It Feels Like</h3>
            <p>Stomach upset that can range from mild queasiness to waves of nausea, especially after eating. Some people just feel "off" after meals. Others feel nauseous throughout the day. Vomiting happens in some cases but is less common than the nausea itself. It is usually worst in the first 1-2 weeks after starting or increasing your dose, then gets better.</p>
          </div>

          <div className="why-box">
            <h3>Why It Happens</h3>
            <p>Semaglutide slows down how fast your stomach empties food — this is called delayed gastric emptying. It is part of how the medication reduces hunger and helps you eat less. But when your body is not used to it yet, the slower movement can make you feel nauseous. Your gut has GLP-1 receptors throughout it, and they are being activated in a way your body has not experienced before.</p>
          </div>
          ...
          <div className="tier-card">
            ...
            <div className="tier-body">
              <div className="action-item">
                <strong>Eat smaller meals.</strong> Instead of 3 big meals, eat 4-5 smaller ones. Your stomach is emptying slower now, so smaller amounts work much better.
              </div>
              <div className="action-item">
              ...
              <div className="action-item">
                <strong>Eat slowly.</strong> Take 20-30 minutes for a meal. Rushing makes nausea significantly worse.
              </div>
              <div className="action-item">
              ...
              <div className="action-item">
                <strong>Stop eating when satisfied, not full.</strong> On this medication, "satisfied" comes sooner. Overeating past that point is the number one trigger for nausea.
              </div>
            </div>
          </div>
          <div className="tier-card">
      ...
      <section className="section" id="diarrhea">
        <div className="container">
          ...
          <div className="what-box">
            <h3>What It Feels Like</h3>
            <p>Loose, watery bowel movements that happen more often than normal. You might feel urgency — needing to get to a bathroom quickly. Some people also get cramping or bloating along with it. It is usually worst during the first 1-2 weeks at a new dose level and improves as your body adjusts.</p>
          </div>

          <div className="why-box">
            <h3>Why It Happens</h3>
            <p>GLP-1 receptors are found throughout your entire digestive system. When semaglutide activates them, it changes how your gut moves food and absorbs water. During the adjustment period, the gut can speed up in some areas while slowing down in others — this mismatch causes diarrhea. Eating fatty or greasy food makes it worse because your body is now processing fats differently.</p>
          </div>
          ...
          <div className="tier-card">
            ...
            <div className="tier-body">
              ...
              <div className="action-item">
                <strong>Try a probiotic.</strong> A daily probiotic supplement can help restore balance to your gut bacteria. Look for one with Lactobacillus and Bifidobacterium strains. Give it 1-2 weeks to take effect.
              </div>
            </div>
          </div>
          <div className="tier-card">
            ...
            <div className="tier-body">
              ...
              <div className="action-item">
                <strong>Take Imodium (loperamide) as needed.</strong> This over-the-counter medication slows down your gut and is safe to use short-term. Follow the package directions.
              </div>
              <div className="action-item">
      ...
      <section className="section section-gray" id="constipation">
        <div className="container">
          ...
          <div className="se-freq">Affects roughly 1-2 out of 10 people</div>
          ...
          <div className="why-box">
            <h3>Why It Happens</h3>
            <p>Semaglutide slows down your entire digestive system — not just your stomach. Food moves through your intestines more slowly, which means more water gets absorbed from the stool before it passes. On top of that, you are eating less food overall, which means less bulk moving through your system.</p>
          </div>
          ...
          <div className="tier-card">
            ...
            <div className="tier-body">
              <div className="action-item">
                <strong>Contact us if you have gone 4-5+ days without a bowel movement,</strong> or if you are experiencing significant pain or bloating. We may recommend a short-term osmotic laxative (MiraLAX) or adjust your dose.
              </div>
            </div>
          </div>
      ...
      {/* ===================== HEARTBURN ===================== */}
      <section className="section" id="heartburn">
        <div className="container">
          <div className="se-header">
          ...
          <div className="se-freq">A frequently reported GI side effect, especially during dose increases</div>

          <div className="what-box">
            <h3>What It Feels Like</h3>
            <p>A burning sensation in your chest or throat, sometimes with a sour or bitter taste in your mouth. It is often worse after eating or when lying down. You might feel like food is sitting in your chest and not going anywhere. Some people mistake it for chest pain. It can range from occasional mild discomfort to daily burning that disrupts sleep.</p>
          </div>

          <div className="why-box">
            <h3>Why It Happens</h3>
            <p>Semaglutide slows gastric emptying, which means food and stomach acid stay in your stomach longer than usual. The valve between your stomach and esophagus (the lower esophageal sphincter) can relax, allowing acid to come back up into your throat. Eating large meals or lying down shortly after eating makes it significantly worse because gravity is no longer helping keep the acid down.</p>
          </div>
          ...
          <div className="tier-card">
            ...
            <div className="tier-body">
              <div className="action-item">
                <strong>Do not lie down for 2-3 hours after eating.</strong> Give gravity time to help keep food and acid in your stomach where it belongs. This single change resolves heartburn for many people.
              </div>
              <div className="action-item">
                <strong>Eat smaller meals.</strong> Your stomach is emptying slower now. Large meals increase pressure and push acid upward.
              </div>
              <div className="action-item">
                <strong>Avoid acidic, spicy foods and caffeine.</strong> These relax the valve at the top of your stomach and increase acid production. Common triggers: coffee, tomato sauce, citrus, chocolate, mint, alcohol.
              </div>
              <div className="action-item">
                <strong>Elevate the head of your bed 6 inches.</strong> Put blocks under the head posts of your bed or use a wedge pillow. This keeps acid from traveling up while you sleep. Extra pillows alone do not work as well — you need to elevate from the waist up.
              </div>
              <div className="action-item">
                <strong>Try an OTC antacid (Tums) for immediate relief.</strong> Calcium carbonate antacids neutralize stomach acid quickly. Good for occasional flare-ups.
              </div>
              <div className="action-item">
                <strong>Try famotidine (Pepcid) 20mg before meals.</strong> This over-the-counter H2 blocker reduces acid production for 8-12 hours. Take it 30 minutes before a meal you expect might trigger heartburn.
              </div>
            </div>
          </div>
          <div className="tier-card">
            ...
            <div className="tier-body">
              <div className="action-item">
                <strong>Try omeprazole (Prilosec) 20mg daily for 2 weeks.</strong> This is a proton pump inhibitor — it shuts down acid production more completely than Pepcid. Take it first thing in the morning, 30 minutes before breakfast. If it helps, continue for up to 8 weeks.
              </div>
              <div className="action-item">
                <strong>Contact us if symptoms are not improving</strong> despite OTC treatment. We may need to adjust your semaglutide dose or prescribe a stronger acid reducer.
              </div>
            </div>
          </div>
          <div className="tier-card">
            ...
            <div className="tier-body">
              <div className="action-item">
                <strong>Severe chest pain.</strong> While heartburn is common, severe or new chest pain should be evaluated to rule out cardiac causes. If pain is crushing, radiates to your arm or jaw, or comes with shortness of breath, call 911.
              </div>
              <div className="action-item">
                <strong>Difficulty swallowing</strong> or feeling like food is getting stuck. This needs evaluation.
              </div>
              <div className="action-item">
                <strong>Vomiting blood</strong> or stool that is black and tarry. This needs immediate attention.
              </div>
              <div className="action-item">
                <strong>Persistent symptoms despite OTC treatment.</strong> If antacids, Pepcid, and Prilosec are not controlling it after 2-4 weeks, we need to reassess.
              </div>
            </div>
          </div>

          <div className="reassure-box">
            <strong>Manageable With Simple Changes</strong>
            <p>Heartburn from semaglutide usually responds well to meal timing adjustments and over-the-counter medications. Most patients find a combination that works within the first few weeks.</p>
          </div>
        </div>
      </section>
      ...
      <section className="section section-gray" id="appetite">
        <div className="container">
          ...
          <div className="why-box">
            ...
            <p>Reduced appetite is the intended effect — that is how semaglutide causes weight loss. But when it goes too far, you stop getting the protein, vitamins, and minerals your body needs. This can lead to muscle loss (instead of just fat loss), nutritional deficiencies, fatigue, hair thinning, and weaker immune function. The goal is to eat less — not to barely eat at all.</p>
          </div>
          ...
          <div className="tier-card">
            ...
            <div className="tier-body">
              <div className="action-item">
                <strong>Contact us for a dose adjustment.</strong> If you consistently cannot eat more than 800-1,000 calories per day despite trying, we need to lower your dose. Losing weight too fast causes muscle loss, gallstones, and nutritional deficiency. Sustainable weight loss means eating enough to protect your body while still losing fat.
              </div>
            </div>
          </div>
      ...
      <section className="section" id="injection">
        <div className="container">
          ...
          <div className="why-box">
            <h3>Why It Happens</h3>
            <p>Any time you put a needle through your skin and inject a substance, your body's immune system notices. It sends some inflammation to the area as part of its normal defense response. This is not an allergic reaction — it is your body reacting to the injection itself. Cold medication can cause more irritation than room-temperature medication.</p>
          </div>
        ...
        <div className="container">
          ...
          <div className="tier-card">
            ...
            <div className="tier-body">
              ...
              <div className="action-item">
                <strong>Add an electrolyte supplement daily.</strong> When you eat less and drink more water, you can flush out sodium, potassium, and magnesium. An electrolyte supplement (LMNT, Liquid IV, or similar) helps maintain energy levels.
              </div>
            </div>
          </div>
          <div className="tier-card">
      ...
      <section className="section" id="hair">
        <div className="container">
          ...
          <div className="se-freq">Starts 2-4 months into treatment — related to rapid weight loss, not the medication itself</div>
          ...
          <div className="why-box">
            <h3>Why It Happens</h3>
            <p>This is called telogen effluvium. When your body goes through a big change — rapid weight loss, major calorie reduction, nutritional stress — it shifts energy away from non-essential functions like hair growth. Hair follicles go into a resting phase and then shed. This happens with any rapid weight loss method, not just semaglutide. It is your body's way of conserving resources during a time of change.</p>
          ...
          <div className="reassure-box">
            ...
            <p>Telogen effluvium is temporary. Once your weight stabilizes and your nutrition is solid, hair growth resumes. Most people see regrowth within 3-6 months after weight stabilizes. The hair that grows back is the same quality as before.</p>
          </div>
        </div>
      </section>
      ...
      <section className="section section-gray" id="dizziness">
        <div className="container">
          ...
          <div className="se-freq">Usually related to blood pressure or blood sugar changes, especially with position changes or skipped meals</div>
          ...
          <div className="why-box">
            <h3>Why It Happens</h3>
            <p>Semaglutide can lower blood pressure and blood sugar — both of which are usually good things, but if they drop too quickly or too far, you feel dizzy. Dehydration makes it worse because lower fluid volume means lower blood pressure. Eating less (especially skipping meals) can cause blood sugar to dip too low, which also triggers dizziness.</p>
          </div>
          ...
          <div className="tier-card">
            ...
            <div className="tier-body">
              ...
              <div className="action-item">
                <strong>Add salt and electrolytes if needed.</strong> If you are eating very little and drinking a lot of water, you may be flushing out sodium. A pinch of salt in your water or an electrolyte drink can help stabilize blood pressure.
              </div>
            </div>
          </div>
          <div className="tier-card">
            ...
            <div className="tier-body">
              ...
              <div className="action-item">
                <strong>You take blood pressure medication.</strong> Semaglutide may lower your blood pressure enough that your existing medication needs to be reduced. This is actually a positive sign — but we need to adjust your other medications to prevent it from going too low.
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="contact-grid">
            <div className="contact-card urgent">
              ...
              <ul>
                ...
                <li>Severe pain of any kind not responding to the steps above</li>
              </ul>
            </div>
      ...
      <section className="section">
        <div className="container">
          <div className="disclaimer">
            <p><strong>Important:</strong> This guide is for Range Medical patients currently on semaglutide therapy. It is not a substitute for personalized medical advice. Do not change your dose without talking to your provider first. All protocols are monitored by licensed providers. Individual results vary.</p>
          </div>
        </div>
      </section>
