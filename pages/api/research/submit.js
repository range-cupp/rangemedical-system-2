        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05);">
          ...
          <tr>
            <td style="padding: 0 40px 32px; text-align: center;">
              ...
              <a href="https://range-medical.com/range-assessment" style="display: inline-block; background-color: #171717; color: #ffffff; font-size: 16px; font-weight: 600; text-decoration: none; padding: 14px 32px; border-radius: 8px;">Book Your Range Assessment</a>
            </td>
          </tr>
