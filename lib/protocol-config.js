...
export const PEPTIDE_OPTIONS = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'Recovery 4-Blend (BPC-157/TB-4/KPV/MGF)', startingDose: '500mcg/125mcg/100mcg/50mcg', maxDose: '500mcg/125mcg/100mcg/50mcg', frequency: 'Daily', notes: 'Reconstitute with 2mL BAC water. 10mg BPC/10mg TB/2mg KPV/1mg MGF vial. 10-30 day programs.' },
    ]
  },
  {
    group: 'Weight Loss',
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'HCG', startingDose: '500 IU', maxDose: '2000 IU', frequency: '2x per week', notes: 'Reconstitute with 2mL BAC water. 5000 IU/vial.', doses: ['250 IU', '500 IU', '750 IU', '1000 IU', '1500 IU', '2000 IU'] },
    ]
  },
  {
    group: 'Mitochondrial',
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'NAD+', startingDose: '25mg', maxDose: '150mg', doseOptions: ['25mg', '50mg', '75mg', '100mg', '125mg', '150mg'], frequency: '3x weekly (Mon/Wed/Fri)', notes: 'Injectable. 125mg/mL ready-to-draw solution. 30/60-day programs.' },
    ]
  },
  {
    group: 'Oral Peptides',
...
export const TESTOSTERONE_DOSES = {
  male: [
    { value: '0.1ml/20mg', label: '0.1ml / 20mg' },
    { value: '0.15ml/30mg', label: '0.15ml / 30mg' },
...
export const WL_INJECTION_PRICING = {
  'Tirzepatide': {
    '1.25mg': 5000, '2.5mg': 10000, '5mg': 13700, '7.5mg': 15000, '10mg': 16200, '12.5mg': 17500,
  },
  'Retatrutide': {
...
export const WL_BUILDER_DOSES = {
  'Tirzepatide': ['1.25mg', '2.5mg', '5mg', '7.5mg', '10mg', '12.5mg'],
...
export const INJECTION_PRICING = {
  standard: {
    ...
    items: ['B12', 'B-Complex', 'B-12 / B-Complex', 'Vitamin D3', 'Biotin', 'Amino Blend', 'BCAA', 'NAC'],
  },
  premium: {
...
export const HRT_SECONDARY_DOSAGES = {
  'HCG': {
    ...
    supplyTypes: [
      { value: 'vial_5000iu', label: 'Vial (5000 IU)' },
      { value: 'prefilled', label: 'Pre-filled syringes' },
    ],
    iuPerVial: 5000,
  },
  'Gonadorelin': {
...
// ================================================================
// HCG PRICING — dynamic calculation in POS checkout
// $50 per 1,000 IU consumed. COGS: $35 per 5,000 IU vial (~84% margin)
// ================================================================
export const HCG_PRICING = {
  centsPerThousandIU: 5000,
  iuPerVial: 5000,
  doses: ['250 IU', '500 IU', '750 IU', '1000 IU', '1500 IU', '2000 IU'],
  frequencies: [
...
export const PEPTIDE_PRODUCT_CATALOG = [
  ...
  // ── SS-31 / Elamipretide (Mitochondrial) ─────────────────────────
  {
    ...
    vialId: 'ss31',
    durations: [
      { days: 25, label: '25 Day' },
    ],
    phases: [
      { phase: 1, label: '1mg Dose (25 injections)', dose: '1mg', price: 500 },
      { phase: 2, label: '2mg Dose (25 injections)', dose: '2mg', price: 500 },
    ],
    matchPatterns: [
  ...
  // ── HCG (HRT Support) ───────────────────────────────────────────
  {
    ...
    hcgConfig: true,
    durations: [],
    matchPatterns: [/^hcg/i, /hcg.*protocol/i, /hcg.*\d+/i],
  },
];
...
export const PEPTIDE_PROGRAM_NAMES = {
  ...
  cognitive:    'Energy & Optimization Program',
  peptide:      'Energy & Optimization Program',
  hrt_support:  'HRT Support Program',
};
