  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        .step-badge { display: inline-flex; align-items: center; justify-content: center; background: var(--color-primary); color: #ffffff; font-size: 0.8125rem; font-weight: 700; letter-spacing: 0.05em; padding: 6px 20px; border-radius: 999px; margin-bottom: 18px; }
        ...
        .pricing-card { border: 1px solid var(--color-border); border-radius: 999px; padding: 32px 48px; margin-top: 24px; text-align: center; box-shadow: var(--shadow-sm); background: var(--color-bg); }
        ...
        .proof-card { background: var(--color-bg); border: 1px solid var(--color-border); border-radius: 999px; padding: 36px 44px; max-width: 680px; text-align: left; box-shadow: var(--shadow-sm); }
