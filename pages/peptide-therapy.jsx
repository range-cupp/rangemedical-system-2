...
export default function PeptideTherapy() {
  ...
  const steps = [
    { step: "Step 1", title: "Take your assessment", desc: "Start with a Range Assessment ($250, credited toward treatment). We'll discuss your goals, medical history, and determine which peptides might help your situation." },
          ...
          <div className="pep-container">
            <div className="pep-animate">
              ...
              <p className="pep-body-text" style={{ textAlign: 'center', margin: '0 auto 2.5rem' }}>
                Start with a Range Assessment ($250, credited toward treatment). We'll discuss your goals and design a peptide protocol for your situation. Our Newport Beach team is here to help.
              </p>
              <div className="pep-cta-buttons">
                <Link href="/range-assessment?path=injury" className="pep-btn-primary">Take Your Assessment</Link>
