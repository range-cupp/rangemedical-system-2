...
<div style="background:#fafafa;border:1px solid #e5e5e5;padding:20px 24px;margin:0 0 12px;">
  ...
  <p style="margin:0 0 4px;font-size:14px;color:#737373;">12-week commitment &mdash; <s>${originalPrice}</s> &mdash; save ${savings} per cycle</p>
...
${p(`Because you just experienced it firsthand, we want to make it easy to keep going. <strong>For the next 7 days, we are offering discounted membership pricing for a 12-week commitment:</strong>`)}
${allPricingCards()}
${p(`Discounted pricing for all three 4-week cycles of your 12-week commitment. After that, continues at the regular membership rate. HSA/FSA accepted.`)}
...
${p(`We mentioned your discounted membership pricing earlier this week. Here is the full breakdown — these rates apply for all three 4-week cycles of a 12-week commitment:`)}
${allPricingCards()}
<div style="background:#f0f7f1;border:1px solid #d4e8d6;padding:16px 20px;margin:0 0 20px;">
  ...
  <p style="margin:0 0 4px;font-size:14px;color:#525252;">&#10003; &nbsp;12-week commitment, discounted rate the entire time</p>
...
${p(`Your discounted 12-week pricing is still available through ${expiryDate}. If you want to lock it in or have questions about what schedule makes sense for you, just reply to this email or give us a call.`)}
${ctaButton('Call or Text — (949) 997-3988')}
${p(`— Range Medical`)}
  `);
}
...
export function getEmail5Html({ firstName }) {
  return wrap(`
${p(`Hi ${firstName},`)}
${p(`Quick heads up — your discounted 12-week membership pricing expires today.`)}
${allPricingCards()}
${p(`After today, this pricing goes away and memberships go back to the regular rate. If you have been thinking about it, now is the time to lock it in.`)}
