...
export const APPOINTMENT_SERVICES = {
  'Lab / Blood Draw': [
    { name: 'New Patient Blood Draw', duration: 30, category: 'labs', calcomSlug: 'new-patient-blood-draw' },
    { name: 'Follow-Up Blood Draw', duration: 15, category: 'labs', calcomSlug: 'follow-up-blood-draw' },
    { name: 'Initial Lab Review', duration: 30, category: 'labs', calcomSlug: 'initial-lab-review' },
    { name: 'Follow-Up Lab Review', duration: 20, category: 'labs', calcomSlug: 'follow-up-lab-review' },
  ],
  'Injections': [
  ...
  'IV Therapy': [
    { name: 'Range IV', duration: 45, category: 'iv', calcomSlug: 'range-iv' },
  ...
  'Consultations': [
    ...
    { name: 'Follow-Up Consultation', duration: 30, category: 'other', calcomSlug: 'follow-up-consultation' },
    { name: 'Telemedicine Consultation', duration: 30, category: 'other', calcomSlug: null },
    { name: 'Phone Consultation', duration: 15, category: 'other', calcomSlug: null },
  ],
};
