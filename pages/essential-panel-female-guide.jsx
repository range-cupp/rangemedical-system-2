...
export default function EssentialPanelFemaleGuide() {
  ...
  return (
    <Layout
      ...
      description="Your guide to the Essential Blood Panel for women. What we test, why it matters, and what comes next. Range Medical, Newport Beach. (949) 997-3988"
    >
      <Head>
      ...
      <section className="peptide-hero">
        <div className="container">
          ...
          <h1>Essential Blood Panel — Female</h1>
      ...
      <style jsx>{`
        ...
        .accordion-item { background: #ffffff; border: 1px solid #e5e5e5; border-radius: 999px; margin-bottom: -1px; }
