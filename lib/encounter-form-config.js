      ...
      },
      {
        ...
        fields: [
          { key: 'addon_injections', label: 'Add-On Vitamins / Injections', type: 'vitamin_dose', items: [
            ...
            { name: 'Lipo-C (MIC + B12)',       mgPerMl: null, maxCc: 2,  compound: true, strengthLabel: 'MIC + B12 compound' },
            { name: 'Lipo-B (MIC + B Complex)', mgPerMl: null, maxCc: 2,  compound: true, strengthLabel: 'MIC + B Complex compound' },
