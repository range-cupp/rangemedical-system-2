  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Labs, provider review, and experience sessions to know exactly what's happening at the cellular level. $197, 100% credits toward the 6-Week Reset." />
      ...
      <section className="cea-hero">
        <div className="cea-hero-inner">
          ...
          <div className="cea-hero-price-box">
            <div className="cea-hero-price">$197</div>
        ...
        <div className="cea-container">
          ...
          <div className="cea-included-grid">
            ...
            <div className="cea-included-card">
              ...
              <p className="cea-included-desc">If you start the 6-Week Reset within 7 days of your results visit, your entire $197 applies toward the program.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="cea-steps">
            ...
            <div className="cea-step">
              ...
              <div className="cea-step-content">
                ...
                <p>If the 6-Week Reset is right for you, your $197 is credited. If not, you still have your data and plan.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="cea-container">
          <div className="cea-credit-box">
            ...
            <p className="cea-credit-text">
              If you decide to move forward with the full <strong>6-Week Cellular Energy Reset</strong> within 7 days of your results visit, your entire <strong>$197</strong> applies toward the $3,999 program price. You're not paying twice—you're just getting the data first.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="cea-section cea-section-alt">
        <div className="cea-container">
          ...
          <div className="cea-pricing-box">
            ...
            <div className="cea-pricing-price">$197</div>
