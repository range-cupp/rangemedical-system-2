...
export default function ChatApp() {
  ...
  const [tab, setTab] = useState('team'); // 'team' | 'patients' | 'calls' | 'schedule'
  ...
  return (
    <>
      ...
      <div style={{
        ...
        {/* ─── LIST VIEW (Team channels, Patient conversations, Calls, or Schedule) ── */}
        {(view === 'channels' || view === 'patients' || view === 'calls' || view === 'schedule') && (
          <>
            <div style={{
              ...
              <div style={{ display: 'flex', gap: 6, marginBottom: 10 }}>
                ...
                <button
                  ...
                  style={{
                    flex: 1, padding: '9px 12px',
                    background: tab === 'schedule' ? '#0f172a' : '#f1f5f9',
                    color: tab === 'schedule' ? '#fff' : '#475569',
                    border: 'none', borderRadius: 10,
                    fontSize: 14, fontWeight: 600, cursor: 'pointer',
                    display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6,
                    fontFamily: 'inherit',
            ...
            <div style={{ flex: 1, overflowY: 'auto', WebkitOverflowScrolling: 'touch', position: 'relative' }}>
              {tab === 'schedule' ? (
                <ChatCalendar employee={employee} onDial={handleDialCall} />
              ) : tab === 'calls' ? (
                <CallsTabContent
    ...
    <div style={{ padding: '0 12px 12px' }}>
      ...
      {subView === 'keypad' && (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <div style={{ fontSize: 11, color: '#94a3b8', marginTop: 6 }}>Calls your phone, then connects to patient</div>
        </div>
      )}
