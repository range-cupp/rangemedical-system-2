    ...
    >
      ...
      <section className="guide-hero">
        <div className="container">
          <div className="v2-label"><span className="v2-dot" /> YOUR IV THERAPY GUIDE</div>
          <h1>THE RANGE IV</h1>
      ...
      <section className="section section-gray">
        <div className="container">
          <div className="v2-label"><span className="v2-dot" /> YOUR CUSTOM IV</div>
      ...
      <style jsx>{`
        ...
        .combo-box { background: #1a1a1a; color: #ffffff; padding: 1.75rem; text-align: center; }
