...
<div style="background:#fafafa;border:1px solid #e5e5e5;padding:20px 24px;margin:0 0 12px;">
  ...
  <p style="margin:0 0 4px;font-size:24px;font-weight:700;color:#171717;">${price}<span style="font-size:14px;font-weight:400;color:#737373;"> every 4 weeks for your first 3 months</span></p>
  <p style="margin:0 0 4px;font-size:14px;color:#737373;"><s>${originalPrice}</s> &mdash; save ${savings} every 4 weeks</p>
...
${p(`Because you just experienced it firsthand, we want to make it easy to keep going. <strong>For the next 7 days, we are offering you discounted membership pricing for your first 3 months:</strong>`)}
${allPricingCards()}
${p(`Discounted pricing applies to your first 3 months, then continues at the regular membership rate. HSA/FSA accepted. You can upgrade or downgrade anytime.`)}
...
${p(`We mentioned your discounted membership pricing earlier this week. Here is the full breakdown — these rates apply to your first 3 months:`)}
${allPricingCards()}
<div style="background:#f0f7f1;border:1px solid #d4e8d6;padding:16px 20px;margin:0 0 20px;">
  ...
  <p style="margin:0 0 4px;font-size:14px;color:#525252;">&#10003; &nbsp;Discounted rate for your first 3 months, then regular pricing</p>
...
${p(`Your discounted first-3-months pricing is still available through ${expiryDate}. If you want to lock it in or have questions about what schedule makes sense for you, just reply to this email or give us a call.`)}
${ctaButton('Call or Text — (949) 997-3988')}
${p(`— Range Medical`)}
  `);
}
...
export function getEmail5Html({ firstName }) {
  return wrap(`
${p(`Hi ${firstName},`)}
${p(`Quick heads up — your discounted first-3-months membership pricing expires today.`)}
${allPricingCards()}
${p(`After today, this introductory pricing goes away. If you have been thinking about it, now is the time to lock it in.`)}
