...
export default function TesamorelinIpamorelinGuide() {
  return (
    <Layout
      title="2X Blend Guide | Range Medical"
      description="Your guide to the 2X Blend peptide therapy (Tesamorelin + Ipamorelin). Injection instructions, what to expect, and safety information. Range Medical, Newport Beach. (949) 997-3988"
    >
      <Head>
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "MedicalWebPage",
              "name": "2X Blend Peptide Guide — Tesamorelin + Ipamorelin",
              "description": "Patient guide for 2X Blend peptide therapy (Tesamorelin + Ipamorelin) including injection instructions, protocols, and safety information.",
              "url": "https://www.range-medical.com/tesamorelin-ipamorelin-guide",
              "provider": {
      ...
      <section className="section">
        <div className="container">
          ...
          <p className="body-text">Unlike many medicines that force change, peptides support your body's own processes. Think of them as a boost to what your body already knows how to do.</p>
        </div>
      </section>
      ...
      <section className="section section-gray">
        <div className="container">
          ...
          <h2 className="section-title">2X Blend</h2>
          <p className="section-subtitle">Two peptides that work together to help your body release more growth hormone naturally.</p>

          <div className="info-grid-two">
            <div className="info-card">
              <h3>Tesamorelin</h3>
              <p className="peptide-role">The Main Signal</p>
              <p>Tesamorelin tells your brain to release more growth hormone. It's the primary driver in this blend — a growth hormone-releasing hormone (GHRH) analog that stimulates your pituitary gland.</p>
              <ul>
                <li>Helps reduce visceral belly fat</li>
                <li>Supports better body composition</li>
                <li>Studied by the FDA for safety</li>
                <li>Promotes lean muscle retention</li>
              </ul>
            </div>
            <div className="info-card">
              <h3>Ipamorelin</h3>
              <p className="peptide-role">The Clean Boost</p>
              <p>Ipamorelin triggers growth hormone release in a gentle, clean way. It works through a different pathway than Tesamorelin, amplifying the signal without the side effects other options cause.</p>
              <ul>
                <li>Clean growth hormone pulse</li>
                <li>No cortisol or hunger spikes</li>
                <li>Well-tolerated by most people</li>
                <li>Complements Tesamorelin's action</li>
              </ul>
            </div>
          </div>
          ...
          <div className="combo-box">
            <h3>Why Together?</h3>
            <p>Tesamorelin and Ipamorelin work through two different mechanisms. Tesamorelin stimulates growth hormone release through the GHRH pathway, while Ipamorelin does the same through the ghrelin pathway. Together, they produce a stronger, more sustained growth hormone pulse than either peptide alone — giving you better results at lower individual doses.</p>
          </div>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container">
          ...
          <h2 className="section-title">What Does Growth Hormone Do?</h2>
          <p className="section-subtitle">Growth hormone (GH) is something your body makes naturally. It helps you stay lean, recover fast, and feel energized. But as you get older, your body makes less of it.</p>
          <p className="body-text">The 2X Blend helps your body release more of its own growth hormone. Here's what that can mean for you:</p>
      ...
      <section className="section section-gray">
        <div className="container">
          ...
          <h2 className="section-title">Dosing Phases</h2>
          <p className="section-subtitle">Your dose increases gradually over three phases to let your body adjust and optimize your results.</p>
          ...
          <div className="tip-box">
            <strong>Schedule: 5 on / 2 off</strong>
            <p>Inject 5 days in a row, then take 2 days off. This cycling pattern prevents your body from building tolerance and keeps your growth hormone response strong. 20 injections per month.</p>
          </div>
        </div>
      </section>
      ...
      <section className="section section-dark">
        <div className="container">
          ...
          <div className="timeline-grid-three">
