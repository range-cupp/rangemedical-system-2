...
export const PEPTIDE_PRODUCT_CATALOG = [
  // ── BPC-157/TB4 (Recovery) ──────────────────────────────────────
  {
    ...
    matchPatterns: [
      /bpc.*tb.*10.*day/i, /10.*day.*bpc/i, /10.*day.*recovery/i, /10.*day.*healing/i,
      /bpc.*tb.*20.*day/i, /20.*day.*bpc/i,
      /bpc.*tb.*30.*day/i, /30.*day.*bpc/i,
      /wolverine.*10/i, /wolverine.*30/i,
      /recovery.*jumpstart/i, /recovery.*10/i, /recovery.*protocol.*10/i,
      /peptide.*protocol.*10.*day.*bpc/i, /peptide.*protocol.*20.*day.*bpc/i, /peptide.*protocol.*30.*day.*bpc/i,
    ],
  },
  ...
  // ── Recovery 4-Blend (BPC/TB4/KPV/MGF) ─────────────────────────
  {
    ...
    deliveryOptions: ['in_clinic', 'take_home'],
    durations: [
      { days: 10, label: '10 Day', price: 275 },
      { days: 20, label: '20 Day', price: 500 },
      { days: 30, label: '30 Day', price: 725 },
    ],
    matchPatterns: [
      /4.*blend.*10/i, /4.*blend.*20/i, /4.*blend.*30/i,
      /recovery.*4.*blend/i,
  ...
  // ── GHK-Cu (Skin/Hair) ─────────────────────────────────────────
  {
    ...
    matchPatterns: [
      /ghk.*cu.*protocol/i, /ghk.*cu.*30/i, /^ghk/i,
    ],
  },
  ...
  {
    category: 'skin',
    medication: 'GLOW (GHK-Cu / BPC / TB500)',
    ...
    matchPatterns: [
      /glow.*30/i, /glow.*protocol/i, /^glow\b/i,
    ],
  },
  ...
  // ── 4X Blend: GHRP-2 / Tesamorelin / MGF / Ipamorelin (GH) ───
  {
    ...
    matchPatterns: [
      /4x.*blend/i, /4x.*ghrp/i,
    ],
  },
];

// Helper: find catalog entry by Stripe product name
