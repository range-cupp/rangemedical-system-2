...
export async function logComm({
  ...
  try {
    ...
    if (error) {
      ...
      if (error.message && (error.message.includes('twilio_message_sid') || error.message.includes('provider') || error.message.includes('sent_by') || error.message.includes('html_body') || error.message.includes('media_url'))) {
