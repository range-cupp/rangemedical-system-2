    ...
    sections: [
      {
        ...
        key: 'iv_placement',
        fields: [
          { key: 'body_avatar', label: 'Placement Site (tap body to select)', type: 'body_avatar' },
          { key: 'placement_date', label: 'Placement Date', type: 'text', placeholder: 'MM/DD/YYYY', defaultValue: new Date().toLocaleDateString('en-US') },
      ...
      },
      {
        ...
        fields: [
          ...
          { key: 'attempts', label: 'Insertion Attempts', type: 'button_group', options: ['1', '2', '3', '4', '5+', 'Other'] },
          { key: 'iv_tolerance', label: 'Patient Tolerance', type: 'button_group', options: ['Tolerated well', 'Tolerated poorly', 'Other (Comment)'] },
      ...
      },
      {
        ...
        fields: [
          ...
          { key: 'fluid_type', label: 'IV Fluid', type: 'button_group', options: ['Normal Saline (0.9% NaCl)', 'Dextrose 5% (D5W)'] },
          { key: 'saline_volume', label: 'Fluid Volume (mL)', type: 'button_group', options: ['100', '250', '500', '1000'] },
