...
function JourneyCard({ journey, stage, onAction, isOverdue, formatDate, formatDateTime }) {
  return (
...
function FollowUpCard({ followUp, stage, isOverdue, formatDate, onMarkReviewed }) {
