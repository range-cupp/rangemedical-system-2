      ...
      },
      {
        ...
        fields: [
          ...
          { key: 'vitamins', label: 'Vitamins / Additives', type: 'vitamin_dose', required: true, items: [
            { name: 'Vitamin C (Ascorbic Acid)',      mgPerMl: 500,   maxCc: 10, supplier: 'AnazaoHealth' },
            { name: 'B-Complex (B1, B2, B3, B5, B6)', mgPerMl: null,  maxCc: 3,  supplier: 'Olympia/THS', compound: true },
            { name: 'Vitamin B12 (Methylcobalamin)',   mgPerMl: 10,    maxCc: 3,  supplier: 'AnazaoHealth', unit: 'mg', note: '10,000 mcg/mL' },
            { name: 'Magnesium Chloride',              mgPerMl: 200,   maxCc: 5,  supplier: 'McGuff' },
            { name: 'Calcium Gluconate',               mgPerMl: null,  maxCc: 5,  compound: true },
            { name: 'Zinc Sulfate',                    mgPerMl: 10,    maxCc: 3,  supplier: 'THS' },
            { name: 'Selenium',                        mgPerMl: null,  maxCc: 3 },
            { name: 'Glutathione',                     mgPerMl: 200,   maxCc: 5,  supplier: 'AnazaoHealth' },
            { name: 'Biotin',                          mgPerMl: 10,    maxCc: 3 },
            { name: 'Taurine',                         mgPerMl: 50,    maxCc: 5 },
            { name: 'L-Carnitine',                     mgPerMl: 500,   maxCc: 5,  supplier: 'Olympia/THS' },
            { name: 'Alpha Lipoic Acid (ALA)',         mgPerMl: null,  maxCc: 5 },
            { name: 'Dexpanthenol (B5)',               mgPerMl: null,  maxCc: 3,  compound: true },
            { name: 'Mineral Blend (Mg/Zn/Mn/Cu)',     mgPerMl: null,  maxCc: 5,  supplier: 'THS', compound: true },
            { name: 'NAC (Acetylcysteine)',             mgPerMl: 200,   maxCc: 5,  supplier: 'THS' },
            { name: 'NAD+',                            mgPerMl: 125,   maxCc: 10, supplier: 'AnazaoHealth' },
            { name: 'Methylene Blue',                  mgPerMl: 5,     maxCc: 5,  supplier: 'ALD' },
          ] },
...
function generateIVNote(data) {
  ...
  if (vitamins.length > 0) {
    ...
    vitamins.forEach(v => {
      ...
      if (dose && dose.cc && dose.mg) {
        lines.push(`- ${v} — ${dose.cc} mL (${dose.mg} mg)`);
      } else if (dose && dose.cc) {
        lines.push(`- ${v} — ${dose.cc} mL`);
      } else {
        lines.push(`- ${v}`);
      }
    });
