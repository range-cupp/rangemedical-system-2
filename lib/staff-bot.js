...
// ================================================================
// DOCUMENT CATALOG
// Mirrors the registry in pages/admin/documents.js
// Used by handleSendDocument for fuzzy matching
// ================================================================

const DOCUMENT_CATALOG = [
  // Guides
  { id: 'nad_guide',              name: 'NAD+ Guide',                       url: '/documents/guides/nad_guide.pdf',                    keywords: ['nad', 'nad+', 'nicotinamide'] },
  { id: 'methylene_blue',         name: 'Methylene Blue Guide',             url: '/documents/guides/methylene_blue_guide.pdf',         keywords: ['methylene blue', 'mb', 'blu', 'cognitive'] },
  { id: 'mb_vitc_combo',          name: 'MB + Vitamin C Combo Guide',       url: '/documents/guides/methylene_blue_combo_guide.pdf',   keywords: ['methylene blue combo', 'mb vitc', 'mb vitamin c', 'the blu'] },
  { id: 'vitamin_c',              name: 'Vitamin C Infusion Guide',         url: '/documents/guides/vitamin_c_guide.pdf',              keywords: ['vitamin c', 'vit c', 'ascorbic'] },
  { id: 'glutathione',            name: 'Glutathione Guide',                url: '/documents/guides/glutathione_guide.pdf',            keywords: ['glutathione', 'antioxidant', 'detox'] },
  { id: 'range_iv',               name: 'Range IV Guide',                   url: '/documents/guides/range_iv_guide.pdf',               keywords: ['range iv', 'iv therapy', 'infusion', 'iv drip'] },
  { id: 'cellular_reset',         name: '6-Week Cellular Reset Guide',      url: '/documents/guides/cellular_reset_guide.pdf',         keywords: ['cellular reset', '6 week', 'reset package'] },
  { id: 'hbot',                   name: 'HBOT Guide',                       url: '/documents/guides/hbot_guide.pdf',                   keywords: ['hbot', 'hyperbaric', 'oxygen therapy', 'chamber'] },
  { id: 'hbot_membership',        name: 'HBOT Membership Guide',            url: '/documents/guides/hbot_membership_guide.pdf',        keywords: ['hbot membership', 'hyperbaric membership'] },
  { id: 'red_light',              name: 'Red Light Therapy Guide',          url: '/documents/guides/red_light_guide.pdf',              keywords: ['red light', 'rlt', 'photobiomodulation', 'infrared'] },
  { id: 'rlt_membership',         name: 'RLT Membership Guide',             url: '/documents/guides/rlt_membership_guide.pdf',         keywords: ['red light membership', 'rlt membership'] },
  { id: 'hrt',                    name: 'HRT Guide',                        url: '/documents/guides/hrt_guide.pdf',                    keywords: ['hrt', 'hormone', 'testosterone', 'estrogen', 'hormones'] },
  { id: 'tirzepatide',            name: 'Tirzepatide Guide',                url: '/documents/guides/tirzepatide_guide.pdf',            keywords: ['tirzepatide', 'mounjaro', 'glp1', 'glp-1'] },
  { id: 'retatrutide',            name: 'Retatrutide Guide',                url: '/documents/guides/retatrutide_guide.pdf',            keywords: ['retatrutide', 'glp1', 'glp-1', 'weight loss peptide'] },
  { id: 'wl_medication',          name: 'Weight Loss Medication Guide',     url: '/documents/guides/weight_loss_medication_guide.pdf', keywords: ['weight loss', 'semaglutide', 'ozempic', 'wegovy', 'weight medication'] },
  { id: 'bpc_tb4',                name: 'BPC-157 / TB4 Guide',              url: '/documents/guides/bpc_tb4_guide.pdf',                keywords: ['bpc', 'bpc157', 'bpc-157', 'tb4', 'tb-4', 'thymosin', 'peptide healing'] },
  { id: 'glow',                   name: 'GLOW Peptide Guide',               url: '/documents/guides/glow_guide.pdf',                   keywords: ['glow', 'skin peptide', 'collagen peptide', 'beauty peptide'] },
  { id: 'ghk_cu',                 name: 'GHK-Cu Guide',                     url: '/documents/guides/ghk_cu_guide.pdf',                 keywords: ['ghk', 'ghk-cu', 'copper peptide', 'skin'] },
  { id: '3x_blend',               name: '3x Blend Guide',                   url: '/documents/guides/3x_blend_guide.pdf',               keywords: ['3x blend', 'three blend', 'peptide blend', 'stack'] },
  { id: 'combo_membership',       name: 'Combo Membership Guide',           url: '/documents/guides/combo_membership_guide.pdf',       keywords: ['combo membership', 'combo', 'hbot rlt membership'] },
  { id: 'the_blu',                name: 'The Blu Guide',                    url: '/documents/guides/the_blu_guide.pdf',                keywords: ['the blu', 'blu package'] },
  // Lab panel guides
  { id: 'essential_male_guide',   name: 'Essential Panel — Male',           url: '/documents/guides/essential_panel_male_guide.pdf',   keywords: ['essential male', 'essential panel male', 'male labs', 'essential labs male'] },
  { id: 'essential_female_guide', name: 'Essential Panel — Female',         url: '/documents/guides/essential_panel_female_guide.pdf', keywords: ['essential female', 'essential panel female', 'female labs', 'essential labs female'] },
  { id: 'elite_male_guide',       name: 'Elite Panel — Male',               url: '/documents/guides/elite_panel_male_guide.pdf',       keywords: ['elite male', 'elite panel male', 'elite labs male'] },
  { id: 'elite_female_guide',     name: 'Elite Panel — Female',             url: '/documents/guides/elite_panel_female_guide.pdf',     keywords: ['elite female', 'elite panel female', 'elite labs female'] },
  // Service sheets
  { id: 'svc_iv',                 name: 'IV Therapy Info Sheet',            url: '/documents/services/range_medical_ivtherapy.pdf',    keywords: ['iv sheet', 'iv info', 'iv service'] },
  { id: 'svc_nad',                name: 'NAD+ Therapy Info Sheet',          url: '/documents/services/range_medical_nad.pdf',          keywords: ['nad sheet', 'nad info'] },
  { id: 'svc_injections',         name: 'Vitamin Injections Info Sheet',    url: '/documents/services/range_medical_injections.pdf',   keywords: ['injection sheet', 'vitamin injection info', 'b12 injection info'] },
  { id: 'svc_peptides',           name: 'Peptide Therapy Info Sheet',       url: '/documents/services/range_medical_peptides.pdf',     keywords: ['peptide sheet', 'peptide info'] },
  { id: 'svc_hbot',               name: 'Hyperbaric Oxygen Info Sheet',     url: '/documents/services/range_medical_hyperbaric.pdf',   keywords: ['hbot sheet', 'hyperbaric info'] },
  { id: 'svc_redlight',           name: 'Red Light Therapy Info Sheet',     url: '/documents/services/range_medical_redlight.pdf',     keywords: ['red light sheet', 'rlt info'] },
  { id: 'svc_hormone',            name: 'Hormone Optimization Info Sheet',  url: '/documents/services/range_medical_hormone.pdf',      keywords: ['hormone sheet', 'hormone info', 'hrt info'] },
  { id: 'svc_weightloss',         name: 'Weight Loss Info Sheet',           url: '/documents/services/range_medical_weightloss.pdf',   keywords: ['weight loss sheet', 'weight loss info'] },
  { id: 'svc_prp',                name: 'PRP Info Sheet',                   url: '/documents/services/range_medical_prp.pdf',          keywords: ['prp sheet', 'prp info', 'platelet'] },
  { id: 'svc_exosome',            name: 'Exosome Therapy Info Sheet',       url: '/documents/services/range_medical_exosome.pdf',      keywords: ['exosome sheet', 'exosome info'] },
  { id: 'svc_cortisone',          name: 'Cortisone Injection Info Sheet',   url: '/documents/services/range_medical_cortisone.pdf',    keywords: ['cortisone sheet', 'cortisone info'] },
  { id: 'svc_reset',              name: '6-Week Reset Info Sheet',          url: '/documents/services/range_medical_reset.pdf',        keywords: ['reset sheet', 'cellular reset info'] },
  { id: 'svc_combo',              name: 'Combo Membership Info Sheet',      url: '/documents/services/range_medical_combo_membership.pdf', keywords: ['combo sheet', 'combo info'] },
];
...
async function handleSendDocument(params) {
  try {
    ...
    if (method === 'sms') {
      ...
      const message = `Hi ${firstName}! Here's info about ${doc.name} from Range Medical:\n\n${fullUrl}\n\nQuestions? Call us at (949) 997-3988.\n\n- Range Medical`;
...
async function handleGetPatientProtocols(params) {
  try {
    ...
    let query = supabase
      .from('protocols')
      .select('id, type, name, status, start_date, end_date, dosing, current_dose, injection_schedule, sessions_total, sessions_completed, next_lab_date, notes, indication')
      .eq('patient_id', patient.id)
    ...
    for (const p of protocols) {
      ...
      lines.push(`${statusEmoji} **${p.name}** (${p.type.toUpperCase()})`);
      if (p.current_dose || p.dosing) lines.push(`   Dose: ${p.current_dose || p.dosing}`);
      if (p.injection_schedule) lines.push(`   Schedule: ${p.injection_schedule}`);
      if (p.sessions_total) {
        lines.push(`   Sessions: ${p.sessions_completed || 0}/${p.sessions_total}`);
      }
      if (p.next_lab_date) {
        const labDate = new Date(p.next_lab_date).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' });
        lines.push(`   Next labs: ${labDate}`);
      }
