...
export default function IGF1LR3Guide() {
  ...
  return (
    <Layout
      title="IGF-1 LR3 Peptide Guide | Range Medical"
      description="Your guide to IGF-1 LR3 peptide therapy. How it works, what to expect, and protocol details. Range Medical, Newport Beach. (949) 997-3988"
    >
      <Head>
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "MedicalWebPage", "name": "IGF-1 LR3 Peptide Guide", "description": "Patient guide for IGF-1 LR3 peptide therapy including protocol details, timeline, and safety information.", "url": "https://www.range-medical.com/igf1-lr3-guide", "provider": { "@type": "MedicalBusiness", "name": "Range Medical", "telephone": "+1-949-997-3988", "address": { "@type": "PostalAddress", "streetAddress": "1901 Westcliff Dr. Suite 10", "addressLocality": "Newport Beach", "addressRegion": "CA", "postalCode": "92660", "addressCountry": "US" } } }) }} />
      </Head>
      ...
      <section className="peptide-hero">
        <div className="container">
          ...
          <h1>IGF-1 LR3</h1>
          <p className="hero-sub">The growth and recovery peptide — a modified form of Insulin-like Growth Factor 1 with an extended half-life, designed to promote muscle growth, accelerate recovery, and support cellular regeneration.</p>
          <div className="hero-dose">
            <div><span>Dose:</span> 100 mcg per injection</div>
          </div>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container">
          ...
          <h2 className="section-title">What Is IGF-1 LR3?</h2>
          <p className="section-subtitle">IGF-1 LR3 stands for Insulin-like Growth Factor 1, Long R3 — a modified version of the naturally occurring IGF-1 peptide with a significantly longer half-life.</p>
          <p className="body-text">IGF-1 mediates many of the growth-promoting effects of growth hormone in the body. The LR3 modification extends its active life, allowing it to work longer and more effectively than natural IGF-1. Used in short, targeted cycles, IGF-1 LR3 supports muscle development, recovery, and overall tissue repair at the cellular level.</p>
        </div>
      </section>
      ...
      <section className="section section-gray">
        <div className="container">
          ...
          <h2 className="section-title">What IGF-1 LR3 Does</h2>
          <p className="section-subtitle">Four key mechanisms that make IGF-1 LR3 a powerful peptide for growth and recovery.</p>
          <div className="info-grid">
            <div className="info-card">
              <h3>Muscle Growth</h3>
              <ul>
                <li>Promotes muscle cell proliferation</li>
                <li>Enhances protein synthesis</li>
                <li>Supports lean tissue development</li>
              </ul>
            </div>
            <div className="info-card">
              <h3>Recovery</h3>
              <ul>
                <li>Accelerates recovery between training sessions</li>
                <li>Reduces downtime from intense activity</li>
                <li>Supports faster return to peak performance</li>
              </ul>
            </div>
            <div className="info-card">
              <h3>Fat Metabolism</h3>
              <ul>
                <li>Supports fat utilization for energy</li>
                <li>Promotes favorable body composition</li>
            ...
            <div className="info-card">
              ...
              <ul>
                <li>Promotes new cell growth</li>
                <li>Supports tissue repair and regeneration</li>
                <li>Enhances the body's natural repair processes</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="section">
        <div className="container">
          ...
          <h2 className="section-title">How to Use IGF-1 LR3</h2>
          ...
          <div className="info-grid">
            <div className="info-card">
              ...
              <p>5 days on, 2 days off. Maintain this cycle throughout your protocol for consistent results.</p>
            </div>
            <div className="info-card">
              <h3>Injection Site</h3>
              <p>Subcutaneous or intramuscular injection as directed by your provider. Rotate injection sites to prevent irritation.</p>
            </div>
            <div className="info-card">
              <h3>Duration</h3>
              <p>7-day cycles — short and targeted. Your provider will determine the appropriate number of cycles based on your response.</p>
            </div>
            <div className="info-card">
              <h3>Storage</h3>
              <p>Keep refrigerated at all times. Use within the cycle window. Remove from fridge a few minutes before injection to reach room temperature.</p>
            </div>
          </div>
          <div className="tip-box" style={{ marginTop: '1.5rem' }}>
            <strong>Pro Tip</strong>
            <p>IGF-1 LR3 works best in short, focused cycles. Stick to the 5-on/2-off schedule and avoid extending cycles beyond what your provider prescribes.</p>
          </div>
        </div>
      </section>
      ...
      <section className="section section-gray">
        <div className="container">
          ...
          <p className="section-subtitle">IGF-1 LR3 works on a shorter timeline than most peptides. Here's what patients typically experience.</p>
          <div className="timeline-grid">
            <div className="timeline-card">
              <h4>Day 1-3</h4>
              <p>Increased pump during training and early recovery benefits. Many patients notice improved workout performance and reduced soreness within the first few days.</p>
            </div>
            <div className="timeline-card">
              <h4>Day 4-7</h4>
              <p>Noticeable recovery improvement and enhanced performance. Training capacity increases as the peptide reaches full effect during the active cycle.</p>
            </div>
            <div className="timeline-card">
              <h4>Repeated Cycles</h4>
              <p>Compounding benefits with each cycle. Consistent use across multiple short cycles delivers progressive gains in muscle growth, recovery, and body composition.</p>
            </div>
          </div>
        </div>
      </section>
