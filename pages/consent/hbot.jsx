...
` : '';
    ...
    const messageBody = `
HYPERBARIC OXYGEN THERAPY CONSENT FORM SUBMISSION
==================================================
${warningSection}
PATIENT INFORMATION
-------------------
...
`;
    ...
    const templateParams = {
      ...
      message: messageBody,
      content: base64PDF,
      filename: `RangeMedical_HBOTConsent_${formData.lastName}_${formData.firstName}.pdf`
    };
