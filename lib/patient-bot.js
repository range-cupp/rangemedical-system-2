...
export async function generateReply(messageText, patientId) {
  ...
  const systemPrompt = `You are Jack, Range Medical's assistant bot. You help patients via text message. Patients know you're a bot — introduce yourself as "Jack from Range Medical" on first contact.
...
8. On first message to a patient, introduce yourself: "Hey [name]! This is Jack, Range Medical's assistant."
