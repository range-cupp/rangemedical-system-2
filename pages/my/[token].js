        ...
        {!activeForm && (
          <div style={{ margin: '0 20px 20px' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
              <a href="sms:9499973988" style={{ padding: '16px', background: 'white', border: '1px solid #e0e0e0', borderRadius: '14px', textDecoration: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
                <span style={{ fontSize: '18px' }}>💬</span>
                <span style={{ fontSize: '14px', fontWeight: '500', color: '#333' }}>Message Clinic</span>
              </a>
              <a href={`sms:9499973988?body=${encodeURIComponent(`Hi, I'd like to request a refill for my ${protocol?.program_name || 'prescription'}. - ${protocol?.patient_name || ''}`)}`} style={{ padding: '16px', background: 'white', border: '1px solid #e0e0e0', borderRadius: '14px', textDecoration: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
                <span style={{ fontSize: '18px' }}>📦</span>
