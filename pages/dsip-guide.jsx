...
export default function DSIPGuide() {
  ...
  return (
    <Layout
      title="DSIP Peptide Guide | Range Medical"
      description="Your guide to DSIP (Delta Sleep-Inducing Peptide) therapy. How it works, what to expect, and safety information. Range Medical, Newport Beach. (949) 997-3988"
    >
      <Head>
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "MedicalWebPage", "name": "DSIP Peptide Guide", "description": "Patient guide for DSIP (Delta Sleep-Inducing Peptide) therapy including protocol details, timeline, and safety information.", "url": "https://www.range-medical.com/dsip-guide", "provider": { "@type": "MedicalBusiness", "name": "Range Medical", "telephone": "+1-949-997-3988", "address": { "@type": "PostalAddress", "streetAddress": "1901 Westcliff Dr. Suite 10", "addressLocality": "Newport Beach", "addressRegion": "CA", "postalCode": "92660", "addressCountry": "US" } } }) }} />
      </Head>
      ...
      <section className="peptide-hero">
        <div className="container">
          ...
          <h1>DSIP</h1>
          <p className="hero-sub">The sleep and recovery peptide — a naturally occurring neuropeptide that promotes deep, restorative sleep and supports your body's overnight repair processes.</p>
      ...
      <section className="section">
        <div className="container">
          ...
          <h2 className="section-title">What Is DSIP?</h2>
          <p className="section-subtitle">DSIP stands for Delta Sleep-Inducing Peptide. It's a naturally occurring neuropeptide found in the brain that helps regulate sleep architecture.</p>
          <p className="body-text">DSIP promotes delta wave (deep) sleep — the most restorative phase of the sleep cycle. During deep sleep, your body releases growth hormone, repairs tissue, and consolidates memory. Unlike sedatives that force sleep, DSIP works with your body's natural sleep mechanisms to improve the quality and depth of your rest.</p>
        </div>
      </section>
      ...
      <section className="section section-gray">
        <div className="container">
          ...
          <h2 className="section-title">What DSIP Does</h2>
          <p className="section-subtitle">Four key mechanisms that make DSIP a powerful tool for sleep optimization and overnight recovery.</p>
          <div className="info-grid">
            <div className="info-card">
              <h3>Deep Sleep</h3>
              <ul>
                <li>Promotes delta wave sleep, the most restorative sleep phase</li>
                <li>Supports healthy sleep architecture</li>
                <li>Helps regulate natural sleep-wake cycles</li>
              </ul>
            </div>
            <div className="info-card">
              <h3>Stress Reduction</h3>
              <ul>
                <li>May lower cortisol levels</li>
                <li>Helps the body recover from stress</li>
                <li>Supports a calmer transition to sleep</li>
              </ul>
            </div>
            <div className="info-card">
              <h3>Pain Modulation</h3>
              <ul>
                <li>Supports natural pain relief during sleep</li>
                <li>May reduce discomfort that disrupts rest</li>
                <li>Enhances the body's overnight pain management</li>
              </ul>
            </div>
            <div className="info-card">
              <h3>Recovery</h3>
              <ul>
                <li>Enhances overnight muscle recovery</li>
                <li>Supports cellular repair during deep sleep</li>
                <li>Promotes growth hormone release while sleeping</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="section">
        <div className="container">
          ...
          <h2 className="section-title">How to Use DSIP</h2>
          <p className="section-subtitle">Your provider has prescribed a protocol tailored to your sleep needs. Here are the key details to keep in mind.</p>
          <div className="info-grid">
            <div className="info-card">
              <h3>Frequency</h3>
              <p>As needed or nightly, 30-60 minutes before bed. Use on nights when quality sleep is a priority or as part of a nightly routine.</p>
            </div>
            <div className="info-card">
              <h3>Injection Site</h3>
              <p>Subcutaneous injection in the abdomen. Rotate sites to prevent irritation.</p>
            </div>
            <div className="info-card">
              <h3>Duration</h3>
              <p>30-day supply — $200. Use as needed based on your sleep goals. Your provider may adjust based on your response.</p>
            </div>
            <div className="info-card">
              <h3>Storage</h3>
          ...
          <div className="tip-box" style={{ marginTop: '1.5rem' }}>
            ...
            <p>Take DSIP 30-60 minutes before your target bedtime. Dim the lights and avoid screens during this window to complement the peptide's effect on your natural sleep cycle.</p>
          </div>
        </div>
      </section>
      ...
      <section className="section section-gray">
        <div className="container">
          ...
          <p className="section-subtitle">Everyone responds differently, but here's what patients typically experience with DSIP.</p>
          <div className="timeline-grid">
            <div className="timeline-card">
              <h4>First Few Nights</h4>
              <p>Faster sleep onset and noticeably deeper sleep. Many patients report falling asleep more easily and waking less during the night.</p>
            </div>
            <div className="timeline-card">
              <h4>Week 1-2</h4>
              <p>More consistent sleep quality and waking feeling refreshed. Daytime energy and mental clarity begin to improve as sleep debt decreases.</p>
            </div>
            <div className="timeline-card">
              <h4>Week 3+</h4>
              <p>Improved overnight recovery and sustained sleep benefits. Patients often notice better workout recovery, mood stability, and cognitive performance.</p>
            </div>
          </div>
        </div>
      </section>
