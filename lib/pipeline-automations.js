...
/**
 * Ensure the patient has an energy_workup card at `under_review` (or further).
 ...
 */
export async function ensureEnergyWorkupAtUnderReview({
  patientId, reason = 'lab_results_received', skipTaskCreation = false,
}) {
