...
export const BUILDER_ITEMS = [
  ...
  // ═══ WEIGHT LOSS ══════════════════════════════════════════════════════════
  // Titration: all GLP-1s titrate every 4 weeks to minimize GI side effects.
  // Duration tiers are based on clinical trial data (STEP, SURMOUNT, Phase 2).
  // Provider selects duration tier based on patient's weight loss goal.
  {
    id: 'wl-semaglutide',
    name: 'Semaglutide',
    ...
    benefits: [
      ...
      'Gradual 4-week dose titration (0.25 → 0.5 → 1.0 → 1.7 → 2.4 mg) minimizes side effects',
    ],
    ...
    clinicalData: {
      source: 'STEP 1 Trial (Wegovy 2.4 mg, 68 weeks, n=1,961)',
      weightLossTimeline: [
        { months: 3, pctLoss: 6, approxLbs: 12, note: 'Still titrating — early response' },
        { months: 6, pctLoss: 11, approxLbs: 23, note: 'Reaching maintenance dose, steady loss' },
        { months: 9, pctLoss: 14, approxLbs: 30, note: 'Peak loss rate' },
        { months: 12, pctLoss: 15, approxLbs: 33, note: 'Approaching plateau' },
      ],
      plateau: 'Months 12–14',
      maxLoss: '15–17% body weight',
      avgMonthlyLoss: '2–3 lbs/month at maintenance dose',
    },
    priceCents: 35000,
    billingType: 'program',
    duration: 6,
    ...
    durationTiers: [
      { months: 3, label: '3-Month Starter', goalLbs: '10–15', description: 'Titration + early results. Best for patients with <20 lbs to lose or trial period.' },
      { months: 6, label: '6-Month Program', goalLbs: '20–30', description: 'Full titration + 2 months at maintenance dose. Most common starting program.' },
      { months: 9, label: '9-Month Program', goalLbs: '30–40', description: 'Extended maintenance for patients approaching plateau. Near-maximum results.' },
      { months: 12, label: '12-Month Program', goalLbs: '35–50', description: 'Full clinical trial duration. Recommended minimum by obesity medicine guidelines.' },
    ],
  ...
  },
  {
    ...
    benefits: [
      ...
      'SURMOUNT-1 trial: ~14% loss at 6 months, ~22.5% at 17 months (15 mg dose)',
    ...
    titration: {
      ...
      maintenanceDose: '5, 10, or 15 mg (provider decides based on response)',
    },
    clinicalData: {
      source: 'SURMOUNT-1 Trial (Zepbound 15 mg, 72 weeks, n=2,539)',
      weightLossTimeline: [
        { months: 3, pctLoss: 7, approxLbs: 15, note: 'Still titrating — stronger early response than semaglutide' },
        { months: 6, pctLoss: 14, approxLbs: 33, note: 'Approaching or at maintenance dose' },
        { months: 9, pctLoss: 19, approxLbs: 42, note: 'Rapid loss continues' },
        { months: 12, pctLoss: 21, approxLbs: 47, note: 'Approaching plateau at 15 mg' },
      ],
      plateau: 'Months 14–17',
      maxLoss: '22–25% body weight',
      avgMonthlyLoss: '3–4.5 lbs/month at maintenance dose',
    },
    priceCents: 39900,
    billingType: 'program',
    duration: 6,
    ...
    durationEditable: true,
    durationTiers: [
      { months: 3, label: '3-Month Starter', goalLbs: '10–20', description: 'Titration + initial response. Assess medication fit before committing to full program.' },
      { months: 6, label: '6-Month Program', goalLbs: '25–40', description: 'Full titration + maintenance. Most popular — strong results for moderate weight loss.' },
      { months: 9, label: '9-Month Program', goalLbs: '40–55', description: 'Extended maintenance at therapeutic dose. Recommended for patients with 40+ lbs to lose.' },
      { months: 12, label: '12-Month Program', goalLbs: '50–75', description: 'Maximum clinical duration. Best value and outcomes for significant weight loss goals.' },
    ],
    options: [
  ...
  },
  {
    ...
    benefits: [
      'Only triple-action weight loss medication — targets GIP, GLP-1, and glucagon receptors simultaneously',
      'Phase 2 trial: ~17% loss at 6 months, ~24% at 12 months — and still losing (no plateau at 48 weeks)',
      'Glucagon receptor activation increases energy expenditure and fat burning directly',
      'Fastest titration of all GLP-1s (12 weeks to maintenance vs 16–20 for others)',
    ],
    ...
    clinicalData: {
      source: 'Phase 2 Trial (Jastreboff et al., NEJM 2023, 12 mg arm, 48 weeks, n=338)',
      weightLossTimeline: [
        { months: 3, pctLoss: 9, approxLbs: 20, note: 'Fastest early loss of any GLP-1 — just reaching maintenance' },
        { months: 6, pctLoss: 17, approxLbs: 38, note: 'Exceeding semaglutide 12-month results in half the time' },
        { months: 9, pctLoss: 22, approxLbs: 48, note: 'Still in steep loss curve — no plateau' },
        { months: 12, pctLoss: 24, approxLbs: 53, note: 'Trial endpoint — curve still trending down' },
      ],
      plateau: 'Not reached at 48 weeks — estimated 28–30% at 72 weeks',
      maxLoss: '24%+ body weight (ceiling unknown)',
      avgMonthlyLoss: '4–5.5 lbs/month at maintenance dose',
    },
    priceCents: 49900,
    billingType: 'program',
    duration: 6,
    ...
    durationEditable: true,
    durationTiers: [
      { months: 3, label: '3-Month Starter', goalLbs: '15–25', description: 'Full titration + first month at maintenance. Fastest results of any GLP-1.' },
      { months: 6, label: '6-Month Program', goalLbs: '30–50', description: 'At maintenance dose for 3+ months. Already exceeding semaglutide 12-month results.' },
      { months: 9, label: '9-Month Program', goalLbs: '50–70', description: 'Deep into active loss phase — no plateau expected yet. Best for significant goals.' },
      { months: 12, label: '12-Month Program', goalLbs: '70–100+', description: 'Full trial duration. For patients with the most weight to lose — results still accelerating at this point.' },
    ],
    options: [
