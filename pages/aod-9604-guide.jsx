...
export default function AOD9604Guide() {
  ...
  return (
    <Layout
      title="AOD-9604 Peptide Guide | Range Medical"
      description="Your guide to AOD-9604 peptide therapy for fat loss. How it works, what to expect, and safety information. Range Medical, Newport Beach. (949) 997-3988"
    >
      <Head>
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "MedicalWebPage", "name": "AOD-9604 Peptide Guide", "description": "Patient guide for AOD-9604 peptide therapy including protocol details, timeline, and safety information.", "url": "https://www.range-medical.com/aod-9604-guide", "provider": { "@type": "MedicalBusiness", "name": "Range Medical", "telephone": "+1-949-997-3988", "address": { "@type": "PostalAddress", "streetAddress": "1901 Westcliff Dr. Suite 10", "addressLocality": "Newport Beach", "addressRegion": "CA", "postalCode": "92660", "addressCountry": "US" } } }) }} />
      </Head>
      ...
      <section className="peptide-hero">
        <div className="container">
          ...
          <h1>AOD-9604</h1>
          <p className="hero-sub">The fat-loss peptide \u2014 a modified fragment of human growth hormone designed to target fat metabolism without the side effects of full GH therapy.</p>
          <div className="hero-dose">
            <div><span>Dose:</span> 500 mcg daily</div>
            <div><span>Duration:</span> 30 days</div>
            <div><span>Total Injections:</span> 30</div>
          </div>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container">
          ...
          <p className="section-subtitle">AOD-9604 is a modified fragment of human growth hormone, specifically amino acids 177\u2013191 \u2014 the portion of GH responsible for fat metabolism.</p>
          <p className="body-text">Originally developed for anti-obesity research, AOD-9604 isolates the fat-burning mechanism of growth hormone without the growth effects. It stimulates the breakdown of stored fat while inhibiting the formation of new fat. Unlike full growth hormone therapy, AOD-9604 does not affect blood sugar levels or promote cell growth \u2014 making it a targeted, well-tolerated option for patients focused on body composition.</p>
        </div>
      </section>
      ...
      <section className="section section-gray">
        <div className="container">
          ...
          <h2 className="section-title">What AOD-9604 Does</h2>
          <p className="section-subtitle">Four key mechanisms that make AOD-9604 a targeted fat-loss peptide with a clean safety profile.</p>
          <div className="info-grid">
            <div className="info-card">
              <h3>Fat Metabolism</h3>
              <ul>
                <li>Stimulates lipolysis (fat breakdown)</li>
                <li>Targets stubborn fat stores</li>
                <li>Inhibits new fat formation</li>
              </ul>
            </div>
            <div className="info-card">
              <h3>No GH Side Effects</h3>
              <ul>
                <li>Does not affect blood sugar levels</li>
                <li>No growth or proliferative effects</li>
                <li>Safe, well-tolerated metabolic profile</li>
              </ul>
            </div>
            <div className="info-card">
              <h3>Cartilage Support</h3>
              <ul>
                <li>May support cartilage repair</li>
                <li>Promotes joint health and comfort</li>
                <li>Studied for osteoarthritis applications</li>
              </ul>
            </div>
            <div className="info-card">
              <h3>Body Composition</h3>
              <ul>
                <li>Supports lean body composition</li>
                <li>Best results with diet and exercise</li>
                <li>Complements other fat-loss protocols</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="section">
        <div className="container">
          ...
          <h2 className="section-title">How to Use AOD-9604</h2>
          <p className="section-subtitle">Your provider has prescribed a 30-day protocol. Here are the key details to keep in mind.</p>
          <div className="info-grid">
            <div className="info-card">
              <h3>Injection Frequency</h3>
              <p>Daily, in the morning on an empty stomach. Wait at least 20 minutes before eating for optimal absorption.</p>
            </div>
            <div className="info-card">
              <h3>Injection Site</h3>
              <p>Subcutaneous injection in the abdomen near fat deposits. Rotate injection sites daily to prevent irritation.</p>
            </div>
            <div className="info-card">
              <h3>Duration</h3>
              <p>30 days \u2014 $400. Consistency is critical. Do not skip doses. Your provider may recommend extending based on your response.</p>
            </div>
            <div className="info-card">
              <h3>Storage</h3>
          ...
          <div className="tip-box" style={{ marginTop: '1.5rem' }}>
            ...
            <p>Inject first thing in the morning before breakfast. AOD-9604 works best in a fasted state when your body is primed to burn fat for fuel.</p>
          </div>
        </div>
      </section>
      ...
      <section className="section section-gray">
        <div className="container">
          ...
          <p className="section-subtitle">Everyone responds differently, but here's what patients typically experience during an AOD-9604 protocol.</p>
          <div className="timeline-grid">
            <div className="timeline-card">
              <h4>Week 1-2</h4>
              <p>Your body begins responding to the peptide. Some patients notice subtle changes in how their body processes fat. Energy levels may improve. Stay consistent with morning dosing on an empty stomach.</p>
            </div>
            <div className="timeline-card">
              <h4>Week 3-4</h4>
              <p>Noticeable changes in body composition. Patients often report reduced stubborn fat in targeted areas. Clothing may fit differently. Best results come with clean diet and regular exercise.</p>
            </div>
            <div className="timeline-card">
              <h4>Week 5+</h4>
              <p>Continued improvements for patients on extended protocols. Compounding fat-loss benefits as the body adapts. Your provider will assess progress and discuss whether to continue or cycle off.</p>
            </div>
          </div>
        </div>
      </section>
