        ...
        <div className="container">
          <div style={{background: '#000', color: '#fff', borderRadius: '12px', padding: '2rem', marginBottom: '2rem'}}>
            ...
            <div style={{display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1.5rem'}}>
              <div>
                ...
                <div style={{fontSize: '1.5rem', fontWeight: '700', color: '#4ade80'}}>free</div>
          ...
          <div style={{background: '#fafafa', borderRadius: '12px', padding: '1.5rem', marginBottom: '2rem', textAlign: 'center'}}>
            ...
            <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', flexWrap: 'wrap'}}>
              <span style={{background: '#fff', border: '1px solid #e5e5e5', padding: '0.5rem 1rem', borderRadius: '6px', fontSize: '0.875rem'}}>Assessment (free)</span>
              <span>→</span>
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="faq-item" style={{marginBottom: '1rem'}}>
            ...
            <p style={{background: '#fee2e2', padding: '1rem', borderRadius: '8px', fontStyle: 'italic'}}>
              "I hear you. Let me ask—how much have you already spent trying to fix this? Supplements, doctor visits, lost productivity? The Reset is a one-time investment to actually fix the underlying problem. And if the full Reset feels like too much right now, the Assessment is free and gives you real data to make this decision."
            </p>
          </div>
