...
// ================================================================
export const RECOVERY_CYCLE_MAX_DAYS = 84; // 12 weeks
export const RECOVERY_CYCLE_OFF_DAYS = 14; // 2 weeks off between cycles

// Recovery/Healing peptides that count toward the 12-week cycle
...
// ================================================================
export const GH_CYCLE_MAX_DAYS = 84; // 12 weeks
export const GH_CYCLE_OFF_DAYS = 28; // 4 weeks off between cycles

// Growth Hormone peptides that count toward the 12-week cycle
