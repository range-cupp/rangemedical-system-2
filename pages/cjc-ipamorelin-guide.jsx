          ...
          <div className="container">
            ...
            <div className="cjc-protocol-card">
              ...
              <div className="cjc-protocol-note">
                <strong>Note:</strong> Dosing is always personalized at Range Medical. We use your lab results — including IGF-1 levels — to determine the right protocol and monitor your response over time. <Link href="/range-assessment" style={{ color: '#000000', fontWeight: 600 }}>Get started</Link> with Range Medical.
              </div>
            </div>
          </div>
        </section>
