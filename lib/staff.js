...
export const STAFF = [
  ...
  { id: 'brendyn', name: 'Brendyn', role: 'Provider',      color: '#8b5cf6', email: 'brendyn@range-medical.com' },
  { id: 'evan',    name: 'Evan',    role: 'Admin',          color: '#7c3aed', email: 'evan@range-medical.com' },
  { id: 'damon',  name: 'Damon',  role: 'Staff',           color: '#ef4444', email: 'damon@range-medical.com' },
