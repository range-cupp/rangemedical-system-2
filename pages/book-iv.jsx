...
const s = {
  ...
  tabPrice: { fontSize: '12px', fontWeight: 700, background: '#f5f5f5', padding: '2px 8px', borderRadius: '0', color: '#525252' },

  // IV Grid (Range)
  ivGrid: { display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '16px' },
  ivCard: { textAlign: 'left', padding: '24px', borderRadius: '0', border: '1px solid #e5e5e5', background: '#fff', cursor: 'pointer', transition: 'all 0.2s', fontFamily: 'inherit', display: 'flex', flexDirection: 'column' },
  ...
  ivPill: { fontSize: '11px', fontWeight: 600, padding: '4px 10px', borderRadius: '0', background: '#f5f5f5', color: '#525252', border: '1px solid #e5e5e5' },
  ...
  specialtyCard: { textAlign: 'left', padding: '20px', borderRadius: '0', border: '1px solid #e5e5e5', background: '#fff', cursor: 'pointer', transition: 'all 0.2s', fontFamily: 'inherit', position: 'relative' },
  specialtyCardPopular: { border: '2px solid #0891b2' },
  popularBadge: { position: 'absolute', top: '-10px', left: '16px', fontSize: '10px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em', padding: '3px 10px', background: '#0891b2', color: '#fff', borderRadius: '0' },
  ...
  bloodWorkBadge: { marginTop: '10px', fontSize: '11px', fontWeight: 600, color: '#dc2626', background: '#fef2f2', padding: '6px 10px', borderRadius: '0', border: '1px solid #fecaca' },

  // Add-ons
  selectedBanner: { display: 'flex', alignItems: 'center', gap: '16px', padding: '16px 20px', background: '#f5f5f5', borderRadius: '0', marginBottom: '2rem' },
  ...
  addOnCard: { padding: '14px', borderRadius: '0', border: '1px solid #e5e5e5', background: '#fff', cursor: 'pointer', fontSize: '14px', fontWeight: 500, color: '#171717', transition: 'all 0.15s', fontFamily: 'inherit', display: 'flex', alignItems: 'center', gap: '8px' },
  addOnCardSelected: { borderColor: '#171717', background: '#f5f5f5' },
  addOnCheck: { color: '#16a34a', fontWeight: 700 },
  addOnSummary: { marginTop: '16px', padding: '12px', background: '#f0fdf4', borderRadius: '0', border: '1px solid #bbf7d0', fontSize: '14px', fontWeight: 600, color: '#166534', textAlign: 'center' },
  ...
  input: { padding: '12px 14px', borderRadius: '0', border: '1px solid #d1d5db', fontSize: '15px', fontFamily: 'inherit', outline: 'none', transition: 'border-color 0.15s' },
  inputError: { borderColor: '#dc2626' },
  fieldError: { fontSize: '12px', color: '#dc2626', marginTop: '4px' },
  bloodWorkNotice: { padding: '16px', background: '#fef2f2', border: '1px solid #fecaca', borderRadius: '0', fontSize: '14px', color: '#991b1b', lineHeight: 1.6, marginBottom: '1.5rem' },

  // Payment
  summaryBox: { padding: '20px', background: '#fafafa', borderRadius: '0', border: '1px solid #e5e5e5', marginBottom: '1.5rem' },
  ...
  cardElement: { padding: '14px', borderRadius: '0', border: '1px solid #d1d5db', background: '#fff' },
  errorMsg: { padding: '12px', background: '#fef2f2', border: '1px solid #fecaca', borderRadius: '0', color: '#dc2626', fontSize: '14px', marginBottom: '1rem' },

  // Calendar
  calContainer: { borderRadius: '0', overflow: 'hidden', border: '1px solid #e5e5e5', marginTop: '1rem' },

  // Success / Payment confirmed
  paymentSuccess: { textAlign: 'center', padding: '24px', background: '#f0fdf4', borderRadius: '0', border: '1px solid #bbf7d0', marginBottom: '1rem' },
  ...
  doneStep: { display: 'flex', gap: '16px', padding: '16px', background: '#fafafa', borderRadius: '0', alignItems: 'flex-start' },
  ...
  btnPrimary: { padding: '14px 28px', background: '#171717', color: '#fff', border: 'none', borderRadius: '0', fontSize: '15px', fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit', transition: 'background 0.2s' },
  btnSecondary: { padding: '14px 28px', background: '#fff', color: '#525252', border: '1px solid #d1d5db', borderRadius: '0', fontSize: '15px', fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit', transition: 'all 0.2s' },
};
