    ...
    >
      ...
      <section className="section section-gray">
        <div className="container">
          ...
          <h2 className="section-title">BPC-157 + TB-500 + KPV + MGF</h2>
          <p className="section-subtitle">Four peptides that work together to support deep tissue recovery, reduce inflammation, and accelerate healing.</p>
        ...
        <div className="container">
          ...
          <div className="protocol-grid">
            <div className="protocol-card">
              ...
              <div className="protocol-price">$275</div>
            ...
            <div className="protocol-card featured">
              ...
              <div className="protocol-price">$500</div>
            ...
            <div className="protocol-card">
              ...
              <div className="protocol-price">$725</div>
      ...
      <style jsx>{`
        ...
        /* Info Grid — 2x2 for four peptides */
        .info-grid {
          display: grid;
