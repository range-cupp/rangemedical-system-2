...
export const NEW_PATIENT_OFFERS = [
  {
    ...
    stripePriceId: process.env.STRIPE_PRICE_INTRO_IV || null,
  ...
  },
  {
    ...
    stripePriceId: process.env.STRIPE_PRICE_INTRO_HBOT || null,
  ...
  },
  {
    ...
    stripePriceId: process.env.STRIPE_PRICE_INTRO_RLT || null,
    consentTypes: ['hipaa'],
  },
];
