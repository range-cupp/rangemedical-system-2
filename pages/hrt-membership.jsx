    ...
    >
        ...
        <div className="container">
          ...
          <div className="faq-list">
            ...
            <div className="faq-item">
              ...
              <p>Take a Range Assessment ($250, credited toward treatment). We'll review your symptoms, order labs if needed, and determine if HRT is right for you. If it is, you'll start your membership when you begin your protocol.</p>
            </div>
            <div className="faq-item">
      ...
      <section className="final-cta">
        <div className="container">
          ...
          <p>Start with a Range Assessment ($250, credited toward treatment). If HRT is right for you, your $250/month membership includes everything you need.</p>
