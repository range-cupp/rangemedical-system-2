      ...
      <div id="consentContainer" className="consent-page">
        ...
        <form id="consentForm" className="consent-form">
          ...
          <div className="section"><h2 className="section-title">Patient Acknowledgments & Agreement</h2><p className="section-desc">Please read each statement carefully and check the box to confirm your understanding and agreement. <strong>All boxes must be checked to proceed.</strong></p>
            <div className="ack-item"><label><input type="checkbox" id="ack1" className="ack-checkbox" required /><span className="ack-text">I understand that peptide therapies provided by Range Medical are elective wellness and optimization services. These services are not intended to diagnose, treat, cure, or prevent any disease or medical condition. I acknowledge that peptide therapy does not replace evaluation, diagnosis, or treatment by my primary care physician or any specialist.</span></label></div>
            <div className="ack-item"><label><input type="checkbox" id="ack2" className="ack-checkbox" required /><span className="ack-text">I understand that many peptide compounds are used off-label or in an investigational capacity. Off-label use refers to the medically accepted practice of using compounds for purposes, dosages, or routes of administration not specifically included in FDA-approved labeling. I consent to such off-label or investigational use when recommended by Range Medical's clinical staff.</span></label></div>
            <div className="ack-item"><label><input type="checkbox" id="ack3" className="ack-checkbox" required /><span className="ack-text">I understand that individual results from peptide therapy vary and are not guaranteed. Range Medical makes no representations, warranties, or guarantees regarding the specific outcomes, efficacy, or therapeutic benefit of any peptide compound administered or prescribed.</span></label></div>
            <div className="ack-item"><label><input type="checkbox" id="ack4" className="ack-checkbox" required /><span className="ack-text">I have been informed of the risks and potential complications associated with peptide therapy, as detailed above. I accept these risks voluntarily and understand that complications may occur even when all procedures are performed correctly.</span></label></div>
            <div className="ack-item"><label><input type="checkbox" id="ack5" className="ack-checkbox" required /><span className="ack-text">I confirm that I have disclosed all relevant medical history, current medications, known allergies, autoimmune conditions, cancer history, and pre-existing health conditions. I understand that failure to disclose accurate information may compromise the safety of my treatment and that Range Medical shall not be held liable for complications arising from undisclosed medical information.</span></label></div>
            <div className="ack-item"><label><input type="checkbox" id="ack6" className="ack-checkbox" required /><span className="ack-text">I acknowledge that peptide therapy is not a substitute for routine medical care. I understand that I should continue to see my primary care physician and any specialists for the management of existing health conditions and preventive care.</span></label></div>
            <div className="ack-item"><label><input type="checkbox" id="ack7" className="ack-checkbox" required /><span className="ack-text">If I am self-administering peptides at home, I understand that I am solely responsible for proper storage, reconstitution, dosing, injection technique, and disposal of materials as instructed. I agree to follow all instructions provided by Range Medical and to contact the clinic immediately if I experience any adverse reaction or uncertainty about my protocol.</span></label></div>
            <div className="ack-item"><label><input type="checkbox" id="ack8" className="ack-checkbox" required /><span className="ack-text">I agree to immediately notify Range Medical staff if I experience any adverse reaction, unusual symptoms, or change in my condition during or after treatment.</span></label></div>
            <div className="ack-item"><label><input type="checkbox" id="ack9" className="ack-checkbox" required /><span className="ack-text">I understand that I have the right to refuse or discontinue treatment at any time without penalty.</span></label></div>
            <div className="ack-item"><label><input type="checkbox" id="ack10" className="ack-checkbox" required /><span className="ack-text">I voluntarily assume full responsibility for any risks associated with peptide therapy. I release, discharge, and hold harmless Range Medical, its medical director, physicians, nurse practitioners, registered nurses, medical assistants, staff, and affiliated entities from any and all claims, liabilities, damages, or causes of action arising out of or related to the services provided, except in cases of gross negligence or willful misconduct.</span></label></div>
            <div className="ack-item"><label><input type="checkbox" id="ack11" className="ack-checkbox" required /><span className="ack-text">I acknowledge that I am financially responsible for all services rendered. Payment is due at the time of service. Refunds are not provided for completed treatments or dispensed medications.</span></label></div>
            <div className="ack-item"><label><input type="checkbox" id="ack12" className="ack-checkbox" required /><span className="ack-text">I authorize Range Medical to contact me via phone, text message, and/or email for purposes related to my care.</span></label></div>
            <div className="ack-item"><label><input type="checkbox" id="ack13" className="ack-checkbox" required /><span className="ack-text">I confirm that I am at least 18 years of age, that I have read this consent form in its entirety, that I have had the opportunity to ask questions, and that I am signing voluntarily.</span></label></div>
          </div>
