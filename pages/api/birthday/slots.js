...
// Cal.com event type slugs → IDs
// These are looked up dynamically, but we cache the slug-to-embed mapping
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (date === todayStr) {
      ...
      // slots is an object keyed by date, each value is an array of slot objects
      filteredSlots = {};
    ...
    console.error('Birthday slots error:', error);
