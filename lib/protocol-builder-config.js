...
export const BUILDER_ITEMS = [
  ...
  // ── BPC-157 Standalone (gut-focused or single-peptide) ────────────────────
  {
    id: 'pep-bpc157-10',
    name: 'BPC-157 — 10 Day',
    category: 'peptide', subcategory: 'recovery',
    description: 'Gut healing, tissue repair — standalone BPC',
    benefits: [
      'Targeted gut lining repair — leaky gut, IBS, post-antibiotic recovery',
      'Accelerates tendon, ligament, and muscle healing',
      'Reduces inflammation at injury sites without NSAIDs',
      'Lower cost entry point vs combo blends when only BPC is needed',
    ],
    bestFor: 'Gut-focused patients, mild injuries, patients who only need BPC without TB-4',
    included: ['Pre-filled syringes', 'Daily 500mcg injections', 'Provider guidance'],
    priceCents: 13500, billingType: 'flat', duration: null, durationLabel: '10 Days', paymentOptions: {},
  },
  {
    id: 'pep-bpc157-20',
    name: 'BPC-157 — 20 Day',
    ...
    description: 'Gut healing, tissue repair — standalone BPC',
    benefits: [
      'Extended gut and tissue repair protocol',
      'Most popular duration for gut healing protocols',
      'Reduces inflammation and accelerates tendon/ligament healing',
      'Lower cost vs combo blends when only BPC is needed',
    ],
    bestFor: 'Moderate gut issues, tendon injuries, extended single-peptide recovery',
    included: ['Pre-filled syringes', 'Daily 500mcg injections', 'Provider guidance'],
    priceCents: 26500, billingType: 'flat', duration: null, durationLabel: '20 Days', paymentOptions: {},
  },
  {
    id: 'pep-bpc157-30',
    name: 'BPC-157 — 30 Day',
    ...
    description: 'Gut healing, tissue repair — standalone BPC',
    benefits: [
      'Full 30-day gut and tissue repair protocol',
      'Best for chronic gut conditions requiring sustained BPC exposure',
      'Can be cycled (30 on, 14 off) for ongoing management',
      'Maximum single-peptide recovery at the most affordable price point',
    ],
    bestFor: 'Chronic gut issues, severe tendon damage, long-term single-peptide recovery',
    included: ['Pre-filled syringes', 'Daily 500mcg injections', 'Provider guidance'],
    priceCents: 39700, billingType: 'flat', duration: null, durationLabel: '30 Days', paymentOptions: {},
  },
  ...
  },
  {
    ...
    benefits: [
      ...
      '4-week cycles with 4-week breaks to prevent receptor desensitization',
    ],
    bestFor: 'Advanced athletes, targeted muscle growth, recovery from muscle injuries',
    included: ['4-week cycle (28 days)', '20–50mcg daily injections', 'Provider monitoring'],
    priceCents: 29700, billingType: 'flat', duration: null, durationLabel: '28 Days', paymentOptions: {},
  },
  ...
  },
  {
    ...
    included: ['Pre-filled syringes', 'Daily 250–500mcg injections', 'Provider guidance'],
    priceCents: 20000, billingType: 'flat', duration: null, durationLabel: '10 Days', paymentOptions: {},
  },
  {
    id: 'pep-selank-20',
    name: 'Selank — 20 Day',
    ...
    description: 'Anxiolytic peptide — focus, calm, cognitive clarity',
    benefits: [
      'Extended protocol for sustained anxiety reduction and cognitive clarity',
      'Enhances focus by modulating GABA and serotonin systems',
      'Most popular duration — enough time to assess full cognitive response',
      'Boosts BDNF expression — synergistic when stacked with BDNF peptide',
    ],
    bestFor: 'Ongoing anxiety, sustained focus improvement, BDNF stack partner',
    included: ['Pre-filled syringes', 'Daily 250–500mcg injections', 'Provider guidance'],
    priceCents: 39500, billingType: 'flat', duration: null, durationLabel: '20 Days', paymentOptions: {},
  },
  {
    id: 'pep-selank-30',
    name: 'Selank — 30 Day',
    ...
    description: 'Anxiolytic peptide — focus, calm, cognitive clarity',
    benefits: [
      'Full 30-day protocol for maximum anxiolytic and cognitive benefit',
      'Sustained GABA and serotonin modulation for lasting calm and focus',
      'Non-addictive with no withdrawal symptoms — safe for full 30-day course',
      'Strongest BDNF upregulation with extended use',
    ],
    bestFor: 'Chronic anxiety, comprehensive cognitive optimization, long-term focus support',
    included: ['Pre-filled syringes', 'Daily 250–500mcg injections', 'Provider guidance'],
    priceCents: 59500, billingType: 'flat', duration: null, durationLabel: '30 Days', paymentOptions: {},
  },
  {
    id: 'pep-semax-10',
    name: 'Semax — 10 Day',
    ...
    included: ['Pre-filled syringes', 'Daily 500mcg–1mg injections', 'Provider guidance'],
    priceCents: 20000, billingType: 'flat', duration: null, durationLabel: '10 Days', paymentOptions: {},
  },
  {
    id: 'pep-semax-20',
    ...
    description: 'Nootropic peptide — memory, learning, neuroprotection',
    benefits: [
      'Extended neuroprotection and cognitive enhancement protocol',
      'Most popular duration — sustained dopamine and serotonin metabolism boost',
      'Enhances memory consolidation and learning speed over full 20 days',
      'Protects neurons from oxidative stress — cumulative neuroprotective benefit',
    ],
    bestFor: 'Sustained cognitive optimization, memory support, post-concussion recovery',
    included: ['Pre-filled syringes', 'Daily 500mcg–1mg injections', 'Provider guidance'],
    priceCents: 39500, billingType: 'flat', duration: null, durationLabel: '20 Days', paymentOptions: {},
  },
  {
    ...
    description: 'Nootropic peptide — memory, learning, neuroprotection',
    benefits: [
      'Full 30-day neuroprotection and cognitive performance protocol',
      'Maximum duration for deepest memory, learning, and focus enhancement',
      'Sustained dopamine and serotonin metabolism improvement',
      'Strongest neuroprotective effect with extended use — ideal for TBI/concussion recovery',
    ],
    bestFor: 'Comprehensive cognitive restoration, TBI recovery, long-term neuroprotection',
    included: ['Pre-filled syringes', 'Daily 500mcg–1mg injections', 'Provider guidance'],
    priceCents: 59500, billingType: 'flat', duration: null, durationLabel: '30 Days', paymentOptions: {},
  },
  ...
  },
  {
    ...
    priceCents: 53000, billingType: 'flat', duration: null, durationLabel: '20 Days', paymentOptions: {},
  },
  {
    id: 'pep-ara290',
    name: 'ARA-290',
    ...
    included: ['Take-home vial', 'Daily 2–4mg injections', 'Provider monitoring'],
    priceCents: 29700, billingType: 'flat', duration: null, durationLabel: '28 Days', paymentOptions: {},
  },
  ...
  {
    id: 'pep-ss31-25',
    name: 'SS-31 (Elamipretide) — 25 Day',
    ...
    included: ['25 daily injections (1mg or 2mg)', 'Take-home vial', 'Provider monitoring'],
    priceCents: 50000, billingType: 'flat', duration: null, durationLabel: '25 Days', paymentOptions: {},
  },
  {
    id: 'pep90-nad-inj',
  ...
  },
  {
    ...
    name: 'Selank Vial',
    category: 'peptide', subcategory: 'vial',
    description: '250–500mcg daily — anxiolytic/nootropic',
    benefits: ['Anxiety reduction without sedation', 'GABA and serotonin modulation', 'Nasal or subcutaneous administration'],
    bestFor: 'Self-administering patients for anxiety and focus support',
    included: ['Selank vial', 'Reconstitution supplies', 'Dosing guide'],
  ...
  },
  {
    ...
    name: 'Semax Vial',
    category: 'peptide', subcategory: 'vial',
    description: '500mcg–1mg daily — nootropic/neuroprotective',
    benefits: ['Memory and cognitive enhancement', 'Neuroprotective effects', 'Nasal or subcutaneous administration'],
    bestFor: 'Self-administering patients for cognitive optimization',
    included: ['Semax vial', 'Reconstitution supplies', 'Dosing guide'],
    priceCents: 19800, billingType: 'flat', duration: null, durationLabel: 'Per vial', paymentOptions: {},
  },
  {
    id: 'vial-ta1',
    name: 'Thymosin Alpha-1 Vial',
    category: 'peptide', subcategory: 'vial',
    description: '3–8mg per injection — immune modulator',
    benefits: ['T-cell function restoration', '2x/week dosing or as-needed when sick', 'Long-term immune support'],
    bestFor: 'Self-administering patients for immune optimization',
    included: ['TA-1 vial', 'Reconstitution supplies', 'Dosing guide'],
    priceCents: 36300, billingType: 'flat', duration: null, durationLabel: 'Per vial', paymentOptions: {},
  },
  {
    id: 'vial-nad',
  ...
  },
  {
    ...
    name: 'IGF-LR3 Vial',
    category: 'peptide', subcategory: 'vial',
    description: '20-50mcg daily — growth factor',
    benefits: ['Direct growth factor for muscle hypertrophy', 'Long-acting IGF-1 analog', '4-week cycle protocol'],
    bestFor: 'Self-injecting athletes, targeted muscle growth',
    included: ['IGF-LR3 vial', 'Reconstitution supplies', '4-week cycle guide'],
    priceCents: 29700, billingType: 'flat', duration: null, durationLabel: '28 days', paymentOptions: {},
  },
