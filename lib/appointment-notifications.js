...
const SMS_TEMPLATES = {
  confirmation: ({ firstName, serviceName, date, time, isBloodDraw }) =>
    isBloodDraw
      ? `Hi ${firstName}! Your blood draw is confirmed for ${date} at ${time}. Please fast 10-12 hrs before (water & black coffee ok), stay hydrated, and avoid NSAIDs for 48 hrs. Full prep guide: https://www.range-medical.com/lab-prep — See you at Range Medical!`
  ...
  reschedule: ({ firstName, serviceName, date, time, isBloodDraw }) =>
    isBloodDraw
      ? `Hi ${firstName}, your blood draw has been rescheduled to ${date} at ${time}. Remember to fast 10-12 hrs before & stay hydrated. Prep guide: https://www.range-medical.com/lab-prep — See you at Range Medical!`
